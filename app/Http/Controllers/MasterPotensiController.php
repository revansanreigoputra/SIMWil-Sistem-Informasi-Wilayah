...
class MasterPotensiController extends Controller
{
    ...
    public function index(Request $request)
    {
        $menu = [
            ...
            'II' => [
                'sumber_air_bersih','jenis_air_minum','sumber_air_panas','jenis_lembaga','dasar_hukum',
                'jenis_pemilihan','kategori_lembaga_ekonomi','jenis_lembaga_ekonomi','kategori_usaha_pengangkutan','kategori_usaha_jasa_dan_hiburan',
            ],
            'III' => [
                'kategori_sekolah','jenis_sekolah_tingkatan','kategori_prasarana_transportasi_darat','jenis_prasarana_transportasi_darat',
                'kategori_prasarana_transportasi_lainnya','jenis_prasarana_transportasi_lainnya','kategori_prasarana_komunikasi_informasi',
                'jenis_prasarana_komunikasi_informasi','jenis_penginapan','jenis_gedung',
            ],
            'IV' => [
                'jenis_prasarana_kesehatan', 'Jenis_Sarana_Kesehatan', 'Jenis_prasarana_Olah_Raga', 'Tempat_Ibadah'
            ],
        ];
