    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse" id="sidebar-menu" style="">
            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown {{ request()->is('data_keluarga*') || request()->is('anggota_keluarga*') ? 'active' : '' }}">
                    ...
                    {{-- sub menus --}}
                    <div class="dropdown-menu {{ request()->is('data_keluarga*') || request()->is('anggota_keluarga*') ? 'show' : '' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item {{ request()->is('data_keluarga*') ? 'active' : '' }}" href="{{ route('data_keluarga.index') }}">
                                    Data Kepala Keluarga
                                </a>
                                <a class="dropdown-item {{ request()->is('anggota_keluarga*') ? 'active' : '' }}" href="{{ route('anggota_keluarga.index') }}">
