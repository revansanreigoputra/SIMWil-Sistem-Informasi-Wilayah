    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse" id="sidebar-menu" style="">
            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown {{ request()->is('jabatan*') || request()->is('perangkat_desa*') ? 'active' : '' }}">
                    ...
                    <div class="dropdown-menu {{ request()->is('jabatan*') || request()->is('perangkat_desa*') ? 'show' : '' }}">
                        ...
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                <div class="dropdown-item">
                                    <a href="{{ route('jabatan.create') }}" class="d-flex align-items-center justify-content-center">
