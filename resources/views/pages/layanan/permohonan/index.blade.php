                            ...
                            @foreach ($kopTemplate->jenisSurats as $indexJenis => $jenisSurat)
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link @if ($indexJenis === 0) active @endif"
                                        id="{{ $jenisId }}-tab" data-bs-toggle="tab"
                                        data-bs-target="#{{ $jenisId }}" type="button" role="tab"
                        ...
                        <div class="tab-content mt-3" id="jenisSuratSubTabContent-{{ $kopId }}">
                            @foreach ($kopTemplate->jenisSurats as $indexJenis => $jenisSurat)
                                ...
                                <div class="tab-pane fade @if ($indexJenis === 0) show active @endif"
                                    id="{{ $jenisId }}" role="tabpanel" aria-labelledby="{{ $jenisId }}-tab"
                                    tabindex="0">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="4" class="text-center">Belum ada data permohonan
                                                            untuk jenis surat ini ({{ $jenisSurat->nama }}).</td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                        </table>
...
@foreach ($permohonans as $permohonan)
    <x-modal.delete-confirm id="delete-confirm-{{ $permohonan->id }}" title="Yakin hapus data ini?"
        description="Aksi ini tidak bisa dikembalikan." route="{{ route('permohonan.destroy', $permohonan) }}"
