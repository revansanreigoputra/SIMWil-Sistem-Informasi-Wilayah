...
@section('title')
    <div class="d-flex align-items-center border-bottom pb-3 mb-4">
        ...
        <h4 class="fw-bold mb-0 text-dark">Form Surat Keterangan Umum</h4>
    </div>
@endsection
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-header bg-primary text-white fw-bold rounded-top-4">
                    <i class="fas fa-plus-circle me-2"></i> Tambah Surat Keterangan Umum
                </div>
                <div class="card-body p-4">
                    ...
                    <form>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control rounded-3 shadow-sm mb-2" 
                                   id="no_surat" value="003">
                            <input type="text" class="form-control rounded-3 shadow-sm" 
                                   value="/06/DS-LB/PEM/IX/2025" readonly>
                        </div>
                        ...
                        {{-- Isi Surat --}}
                        <div class="mb-4">
                            <label for="isi_surat" class="form-label fw-semibold">Isi Surat</label>
                            <textarea id="isi_surat" class="form-control rounded-3 shadow-sm" rows="6"></textarea>
                        </div>
