...
@section('title')
    <div class="d-flex align-items-center border-bottom pb-3 mb-4">
        ...
        <h4 class="fw-bold mb-0 text-dark"> Tambah Surat Keterangan Belum Pernah Nikah</h4>
    </div>
@endsection
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-header bg-primary text-white fw-bold rounded-top-4">
                    <i class="fas fa-plus-circle me-2"></i> Form Tambah Surat Keterangan Belum Pernah Nikah
                </div>
                <div class="card-body p-4">
                    
                    <form>
                        <h5 class="mb-4 fw-semibold text-dark">TambahSurat Keterangan Belum Pernah Nikah</h5>
