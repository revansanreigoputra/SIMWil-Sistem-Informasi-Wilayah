...
@section('title')
    <div class="d-flex align-items-center border-bottom pb-3 mb-4">
        ...
        <h4 class="fw-bold mb-0 text-dark">Form Surat Keterangan Belum Pernah Nikah</h4>
    </div>
@endsection
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <form>
                            ...
                            {{-- Pernyataan --}}
                            <h5 class="mb-3 text-primary">Pernyataan</h5>
                            <div class="mb-3">
                                <label class="form-label">Keterangan</label>
                                <textarea rows="3" class="form-control">
Belum pernah menikah sampai dengan surat keterangan ini dibuat.
                            </textarea>
                            </div>
