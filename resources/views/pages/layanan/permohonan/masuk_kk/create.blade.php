...
@section('title', 'Pendaftaran Kartu Keluarga Baru (Mutasi Masuk)')

@section('content')
    <div class="container-fluid">
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <h5 class="card-title mb-0">Formulir Pendaftaran Kartu Keluarga Baru (Mutasi Masuk)</h5>
            </div>

            {{-- PERUBAHAN KRUSIAL: Action diarahkan ke metode storeNewKK --}}
            <form action="{{ route('permohonan.masuk_kk.store_new_kk') }}" method="POST">
                @csrf
                ...
                <div class="card-footer d-flex justify-content-between">
                    <a href="{{ route('permohonan.create') }}" class="btn btn-secondary">Batal & Kembali ke
                        Permohonan
                        Surat</a>
                    <button type="submit" class="btn btn-primary">Simpan Data KK Baru & Lanjutkan</button>
                </div>
            </form>
        </div>
    </div>
