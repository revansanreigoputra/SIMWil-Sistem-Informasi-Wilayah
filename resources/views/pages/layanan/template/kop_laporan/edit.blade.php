...
@section('title')
    <div class="d-flex align-items-center border-bottom pb-2 mb-3">
        ...
        <h4 class="fw-bold mb-0 text-dark"> Edit Kop Laporan</h4>
    </div>
@endsection
        ...
        <div class="card shadow-sm border-0 rounded-3">
            ...
            <div class="card-header bg-primary text-white rounded-top">
                <h5 class="mb-0 fw-bold">
                    <i class="fas fa-edit me-2"></i> Edit Kop Laporan
                </h5>
            </div>
            ...
            <div class="card-body bg-light">
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    {{-- Nama Kop Laporan --}}
                    <div class="mb-3">
                        <label for="nama_kop" class="form-label fw-semibold text-dark">Nama Kop Laporan</label>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <a href="{{ route('layanan.template.kop_laporan.index') }}" 
