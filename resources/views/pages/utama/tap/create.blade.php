            ...
            <div class="col-lg-12">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Data Diri & Kontak</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            {{-- KOLOM KIRI --}}
                            <div class="col-md-6">
                                <div class="mb-3">
                                    {{-- Menambahkan ikon dan helper 'old()' --}}
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="alamat" name="alamat" class="form-control" rows="3" placeholder="Masukkan alamat lengkap">{{ old('alamat') }}</textarea>
                                </div>
                            </div>
                            {{-- KOLOM KANAN --}}
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="kontak" name="kontak" class="form-control" value="{{ old('kontak') }}" placeholder="Contoh: 081234567890" required>
                                </div>
                                <div class="mb-3">
                                    <label for="email" class="form-label"><i class="bi bi-envelope-fill me-2"></i>Email *</label>
                                    <input type="email" id="email" name="email" class="form-control" value="{{ old('email') }}" placeholder="Contoh: user@example.com" required>
                                </div>
                                <div class="mb-3">
                                    <label for="tlp" class="form-label"><i class="bi bi-telephone-fill me-2"></i>Telepon Kantor</label>
                                    <input type="text" id="tlp" name="tlp" class="form-control" value="{{ old('tlp') }}" placeholder="Contoh: 021-123456">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Detail Penugasan</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            {{-- KOLOM KIRI --}}
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" id="tgl_tap" name="tgl_tap" class="form-control" value="{{ old('tgl_tap', date('Y-m-d')) }}" required>
                                </div>
                                <div class="mb-3">
                                    <label for="tahun" class="form-label"><i class="bi bi-calendar-fill me-2"></i>Tahun Penugasan *</label>
                                    <input type="number" id="tahun" name="tahun" class="form-control" value="{{ old('tahun', date('Y')) }}" placeholder="{{ date('Y') }}" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select id="id_wk" name="id_wk" class="form-select" required>
                                        ...
                                        @foreach ($wilayah_kerjas as $item)
                                            <option value="{{ $item['id'] }}" {{ old('id_wk') == $item['id'] ? 'selected' : '' }}>{{ $item['nama'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select id="id_ktk" name="id_ktk" class="form-select" required>
                                        ...
                                        @foreach ($kategori_keahlians as $item)
                                            <option value="{{ $item['id'] }}" {{ old('id_ktk') == $item['id'] ? 'selected' : '' }}>{{ $item['nama'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="id_prov" name="id_prov" class="form-select" required>
                                        ...
                                        @foreach ($provinsis as $item)
                                            <option value="{{ $item['id'] }}" {{ old('id_prov') == $item['id'] ? 'selected' : '' }}>{{ $item['nama'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select id="id_kabkot1" name="id_kabkot1" class="form-select" required>
                                        ...
                                        @foreach ($kabupatens as $item)
                                            <option value="{{ $item['id'] }}" {{ old('id_kabkot1') == $item['id'] ? 'selected' : '' }}>{{ $item['nama'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select id="id_kabkot2" name="id_kabkot2" class="form-select">
                                        ...
                                        @foreach ($kabupatens as $item)
                                            <option value="{{ $item['id'] }}" {{ old('id_kabkot2') == $item['id'] ? 'selected' : '' }}>{{ $item['nama'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
