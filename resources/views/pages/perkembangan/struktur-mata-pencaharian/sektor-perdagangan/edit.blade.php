...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('perkembangan.struktur-mata-pencaharian.sektor-perdagangan.update', $perdagangan->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="date" name="tanggal" id="tanggal" class="form-control" 
                       value="{{ old('tanggal', $perdagangan->tanggal) }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="karyawan_perdagangan_hasil_bumi" class="form-control" min="0"
                       value="{{ old('karyawan_perdagangan_hasil_bumi', $perdagangan->karyawan_perdagangan_hasil_bumi) }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="pengusaha_perdagangan_hasil_bumi" class="form-control" min="0"
                       value="{{ old('pengusaha_perdagangan_hasil_bumi', $perdagangan->pengusaha_perdagangan_hasil_bumi) }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="buruh_perdagangan_hasil_bumi" class="form-control" min="0"
                       value="{{ old('buruh_perdagangan_hasil_bumi', $perdagangan->buruh_perdagangan_hasil_bumi) }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="jumlah" class="form-control" min="0"
                       value="{{ old('jumlah', $perdagangan->jumlah) }}">
            </div>
