...
@section('title', 'Data Rumah Menurut Lantai')

@section('action')
    @can('rumah_menurut_lantai.create')
        <a href="{{ route('perkembangan.asetekonomi.rumah_menurut_lantai.create') }}" class="btn btn-primary">
            Tambah Data Rumah Menurut Lantai
        </a>
    @endcan
@endsection
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @canany(['rumah_menurut_lantai.view','rumah_menurut_lantai.update','rumah_menurut_lantai.delete'])
                                    <div class="d-flex gap-1 justify-content-center">
                                        ...
                                        @can('rumah_menurut_lantai.delete')
                                            <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#delete-rumah-lantai-{{ $item->id }}">
                                                Hapus
                                            </button>
                                        @endcan
                                    </div>
                                    ...
                                    <!-- Modal Hapus -->
                                    <div class="modal fade" id="delete-rumah-lantai-{{ $item->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ route('perkembangan.asetekonomi.rumah_menurut_lantai.destroy', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
