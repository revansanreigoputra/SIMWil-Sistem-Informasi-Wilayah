        ...
        <form action="{{ route('perkembangan.asetekonomi.sarana_transportasi_umum.store') }}" method="POST">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-3 mb-2">
                    ...
                    <input type="number" name="jumlah_pemilik" id="jumlah_pemilik" class="form-control" min="0" value="0">
                ...
                <div class="col-md-3 mb-2">
                    ...
                    <input type="number" name="jumlah_aset" id="jumlah_aset" class="form-control" min="0" value="0">
                    @error('jumlah_aset')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
