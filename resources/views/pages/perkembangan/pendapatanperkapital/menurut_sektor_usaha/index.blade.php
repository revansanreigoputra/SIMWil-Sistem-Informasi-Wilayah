                ...
                <tbody>
                    @foreach ($data as $index => $item)
                        <tr>
                            ...
                            {{-- Sektor --}}
                            <td class="text-center">{{ $item->sektor->nama ?? '-' }}</td>
                            ...
                            {{-- Buruh --}}
                            <td class="text-center"><span class="badge bg-warning text-dark">{{ $item->buruh }}</span></td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Data tanggal <strong>{{ \Carbon\Carbon::parse($item->tanggal)->format('d/m/Y') }}</strong>
                                                        dari desa <strong>{{ $item->desa->nama_desa ?? '-' }}</strong> akan dihapus dan tidak bisa dikembalikan.</p>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ route('perkembangan.pendapatanperkapital.menurut_sektor_usaha.destroy', $item->id) }}"
                                                          method="POST">
                                                        @csrf
                                                        @method('DELETE')
