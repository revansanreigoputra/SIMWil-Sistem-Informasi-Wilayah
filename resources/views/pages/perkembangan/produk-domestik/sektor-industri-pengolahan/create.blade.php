...
@section('title', 'Tambah Data Sektor Industri Pengolahan')

@section('content')
<div class="card">
    <div class="card-body">
        <form action="{{ route('perkembangan.produk-domestik.sektor-industri-pengolahan.store') }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="nilai_produksi" class="form-control" required>
            </div>
            <div class="mb-3">
                <label for="nilai_bahan_baku" class="form-label">Total nilai bahan baku (Rp)</label>
                <input type="number" name="nilai_bahan_baku" class="form-control" required>
            </div>
            <div class="mb-3">
                <label for="nilai_bahan_penolong" class="form-label">Total nilai bahan penolong (Rp)</label>
                <input type="number" name="nilai_bahan_penolong" class="form-control" required>
            </div>
            <div class="mb-3">
                <label for="biaya_antara" class="form-label">Total biaya antara (Rp)</label>
                <input type="number" name="biaya_antara" class="form-control" required>
            </div>
            <div class="mb-3">
                <label for="jumlah_jenis_industri" class="form-label">Total jumlah jenis industri (Jenis)</label>
                <input type="number" name="jumlah_jenis_industri" class="form-control" required>
            </div>
