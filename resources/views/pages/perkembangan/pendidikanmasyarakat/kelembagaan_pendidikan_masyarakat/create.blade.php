        ...
        <form action="{{ route('perkembangan.pendidikanmasyarakat.kelembagaan.store') }}" method="POST">
            ...
            <div class="row mt-2">
                <div class="col-md-6 mb-2">
                    ...
                    <input type="number" name="perpustakaan_desa" class="form-control" min="0" value="0" required>
                </div>
                <div class="col-md-6 mb-2">
                    <label>Jumlah Taman Bacaan Desa/Kelurahan (Unit)</label>
                    <input type="number" name="taman_bacaan" class="form-control" min="0" value="0" required>
                </div>

                <div class="col-md-6 mb-2">
                    <label>Jumlah Perpustakaan Keliling (Unit)</label>
                    <input type="number" name="perpustakaan_keliling" class="form-control" min="0" value="0" required>
                </div>
                <div class="col-md-6 mb-2">
                    <label>Jumlah Sanggar Belajar (Unit)</label>
                    <input type="number" name="sanggar_belajar" class="form-control" min="0" value="0" required>
                </div>

                <div class="col-md-6 mb-2">
                    <label>Jumlah Kegiatan Lembaga Pendidikan Luar Sekolah (Kegiatan)</label>
                    <input type="number" name="kegiatan_lps" class="form-control" min="0" value="0" required>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-6 mb-2">
                    ...
                    <input type="number" name="kelompok_a" class="form-control" min="0" value="0" required>
                </div>
                <div class="col-md-6 mb-2">
                    <label>Jumlah Peserta Ujian Paket A (Orang)</label>
                    <input type="number" name="peserta_a" class="form-control" min="0" value="0" required>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-6 mb-2">
                    ...
                    <input type="number" name="kelompok_b" class="form-control" min="0" value="0" required>
                </div>
                <div class="col-md-6 mb-2">
                    <label>Jumlah Peserta Ujian Paket B (Orang)</label>
                    <input type="number" name="peserta_b" class="form-control" min="0" value="0" required>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-6 mb-2">
                    ...
                    <input type="number" name="kelompok_c" class="form-control" min="0" value="0" required>
                </div>
                <div class="col-md-6 mb-2">
                    <label>Jumlah Peserta Ujian Paket C (Orang)</label>
                    <input type="number" name="peserta_c" class="form-control" min="0" value="0" required>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-6 mb-2">
                    ...
                    <input type="number" name="kursus_unit" class="form-control" min="0" value="0" required>
                </div>
                <div class="col-md-6 mb-2">
                    <label>Jumlah Peserta Kursus Keterampilan (Orang)</label>
                    <input type="number" name="peserta_kursus" class="form-control" min="0" value="0" required>
                </div>
            </div>
