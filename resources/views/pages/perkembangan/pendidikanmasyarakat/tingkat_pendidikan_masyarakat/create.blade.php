...
@section('content')
<div class="container">
    <h4 class="mb-4">Tambah Data Tingkat Pendidikan Masyarakat</h4>
    ...
    <form action="{{ route('perkembangan.pendidikanmasyarakat.tingkat_pendidikan_masyarakat.store') }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="number" name="tidak_tamat_sd" id="tidak_tamat_sd" class="form-control">
            </div>
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="number" name="sltp" id="sltp" class="form-control">
            </div>
            <div class="col-md-4 mb-3">
                <label for="slta" class="form-label">SLTA</label>
                <input type="number" name="slta" id="slta" class="form-control">
            </div>
            <div class="col-md-4 mb-3">
                <label for="diploma" class="form-label">Diploma</label>
                <input type="number" name="diploma" id="diploma" class="form-control">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="number" name="sarjana" id="sarjana" class="form-control">
            </div>
            <div class="col-md-4 mb-3">
                <label for="p_buta" class="form-label">% Buta Huruf</label>
                <input type="number" step="0.01" name="p_buta" id="p_buta" class="form-control">
            </div>
            <div class="col-md-4 mb-3">
                <label for="p_tamat" class="form-label">% Tamat Sekolah</label>
                <input type="number" step="0.01" name="p_tamat" id="p_tamat" class="form-control">
            </div>
        </div>

        <div class="mb-3">
            <label for="p_cacat" class="form-label">% Penyandang Cacat</label>
            <input type="number" step="0.01" name="p_cacat" id="p_cacat" class="form-control">
        </div>
