...
@section('title', 'Tambah Data Penjarahan dan Penyerobotan Tanah')
...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white border-bottom">
        <h5 class="card-title mb-0">
            ...
            Tambah Data Penjarahan dan Penyerobotan Tanah
        </h5>
    </div>

    <div class="card-body">
        <form action="{{ route('perkembangan.keamanandanketertiban.penjarahan.store') }}" method="POST">
            @csrf
