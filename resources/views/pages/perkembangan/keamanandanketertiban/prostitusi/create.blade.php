...
@section('title', 'Tambah Data Prostitusi')
...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white border-bottom">
        <h5 class="card-title mb-0">
            ...
            Tambah Data Prostitusi
        </h5>
    </div>

    <div class="card-body">
        <form action="{{ route('perkembangan.keamanandanketertiban.prostitusi.store') }}" method="POST">
            @csrf
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" name="jumlah_penduduk_pramu_nikmat" min="0"
                           ...
                           value="{{ old('jumlah_penduduk_pramu_nikmat') }}" required>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" name="jumlah_tempat_pramunikmat" min="0"
                           ...
                           value="{{ old('jumlah_tempat_pramunikmat') }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="jumlah_kasus_prostitusi" min="0"
                           ...
                           value="{{ old('jumlah_kasus_prostitusi') }}" required>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" name="jumlah_pembinaan_pelaku" min="0"
                           ...
                           value="{{ old('jumlah_pembinaan_pelaku') }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="jumlah_penertiban_tempat" min="0"
                           ...
                           value="{{ old('jumlah_penertiban_tempat') }}" required>
