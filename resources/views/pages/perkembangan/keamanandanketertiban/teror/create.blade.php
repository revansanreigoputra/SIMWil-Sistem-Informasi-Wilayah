...
@section('title', 'Tambah Data Teror dan Intimidasi')
...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white border-bottom">
        <h5 class="card-title mb-0">
            ...
            Tambah Data Teror dan Intimidasi
        </h5>
    </div>

    <div class="card-body">
        <form action="{{ route('perkembangan.keamanandanketertiban.teror.store') }}" method="POST">
            @csrf
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label class="form-label fw-semibold">
                        Jumlah Kasus Intimidasi dan/atau Teror dari Pihak Dalam Desa <span class="text-danger">*</span>
                    </label>
                    <input type="number" name="jumlah_kasus_intimidasi_dalam_desa" min="0"
                           ...
                           value="{{ old('jumlah_kasus_intimidasi_dalam_desa') }}" required>
                ...
                <div class="col-md-6">
                    <label class="form-label fw-semibold">
                        Jumlah Kasus Intimidasi dan/atau Teror dari Pihak Luar Desa <span class="text-danger">*</span>
                    </label>
                    <input type="number" name="jumlah_kasus_intimidasi_luar_desa" min="0"
                           ...
                           value="{{ old('jumlah_kasus_intimidasi_luar_desa') }}" required>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label class="form-label fw-semibold">
                        Jumlah Kasus Selebaran Gelap / Isu Bersifat Teror <span class="text-danger">*</span>
                    </label>
                    <input type="number" name="jumlah_kasus_selebaran_gelap" min="0"
                           ...
                           value="{{ old('jumlah_kasus_selebaran_gelap') }}" required>
                ...
                <div class="col-md-6">
                    <label class="form-label fw-semibold">
                        Jumlah Kasus Terorisme di Desa/Kelurahan Tahun Ini <span class="text-danger">*</span>
                    </label>
                    <input type="number" name="jumlah_kasus_terorisme" min="0"
                           class="form-control @error('jumlah_kasus_terorisme') is-invalid @enderror"
                           value="{{ old('jumlah_kasus_terorisme') }}" required>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label class="form-label fw-semibold">
                        Jumlah Kasus Hasutan dan Pemaksaan Kehendak <span class="text-danger">*</span>
                    </label>
                    <input type="number" name="jumlah_kasus_hasutan_pemaksaan" min="0"
                           ...
                           value="{{ old('jumlah_kasus_hasutan_pemaksaan') }}" required>
                ...
                <div class="col-md-6">
                    <label class="form-label fw-semibold">
                        Jumlah Penyelesaian Kasus Teror dan Intimidasi <span class="text-danger">*</span>
                    </label>
                    <input type="number" name="jumlah_penyelesaian_kasus" min="0"
                           ...
                           value="{{ old('jumlah_penyelesaian_kasus') }}" required>
