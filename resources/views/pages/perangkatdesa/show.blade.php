                    ...
                    <div class="row">
                        <div class="col-md-4">
                            @if($perangkatDesa->foto)
                                <div class="text-center">
                                    <img src="{{ asset('storage/' . $perangkatDesa->foto) }}" alt="Foto {{ $perangkatDesa->nama }}" class="img-fluid rounded" style="max-width: 200px;">
                                </div>
                            @else
                                <div class="text-center">
                        ...
                        <div class="col-md-8">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    <th>Tanggal Lahir</th>
                                    <td>: {{ $perangkatDesa->tanggal_lahir ? \Carbon\Carbon::parse($perangkatDesa->tanggal_lahir)->format('d/m/Y') : '-' }}</td>
                                </tr>
                                <tr>
                                    <th>Jenis Kelamin</th>
                                ...
                                <tr>
                                    <th>Nama Istri</th>
                                    <td>: {{ $perangkatDesa->nama_istri ?: '-' }}</td>
                                </tr>
                                <tr>
                                    <th>Jumlah Anak</th>
