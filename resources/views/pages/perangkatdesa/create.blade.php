        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- Form --}}
                    <form action="{{ route('perangkat_desa.store') }}" method="POST" enctype="multipart/form-data" id="perangkat-desa-form">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mb-0">
                                    ...
                                    <a href="{{ route('perangkat_desa.index') }}" class="btn btn-secondary ml-2">
...
$(document).ready(function() {
    ...
    $('#perangkat-desa-form').on('submit', function(e) {
        ...
        const requiredFields = [
            { field: '#desa_id', message: 'Desa harus dipilih' },
            { field: '#jabatan_id', message: 'Jabatan harus dipilih' },
            { field: '#nama', message: 'Nama harus diisi' },
            { field: '#jenis_kelamin', message: 'Jenis kelamin harus dipilih' }
        ];
