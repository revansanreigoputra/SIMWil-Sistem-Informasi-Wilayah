...
<div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0 fw-bold">
            <i class="bi bi-building-add me-2"></i>Form Tambah Data Desa
        </h5>
    </div>
    ...
    <div class="card-body p-4">
        <form action="{{ route('desa.store') }}" method="POST" id="form-desa">
            ...
            <div class="mb-3 border rounded-3 p-4 bg-light">
                <h6 class="fw-bold mb-3 text-primary"><i class="bi bi-info-circle me-2"></i>Informasi Dasar</h6>
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nama_desa" id="nama_desa" class="form-control @error('nama_desa') is-invalid @enderror" value="{{ old('nama_desa') }}" placeholder="Masukkan nama desa" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="kode_pum" id="kode_pum" class="form-control @error('kode_pum') is-invalid @enderror" value="{{ old('kode_pum') }}" placeholder="Masukkan kode PUM" required>
            ...
            <div class="mb-3 border rounded-3 p-4 bg-light">
                <h6 class="fw-bold mb-3 text-success"><i class="bi bi-geo-alt me-2"></i>Informasi Geografis</h6>
                <div class="row g-3">
                    <div class="col-md-6">
                        <label for="kelurahan_terluar" class="form-label fw-semibold">Kelurahan Terluar</label>
                        <input type="text" name="kelurahan_terluar" id="kelurahan_terluar" class="form-control @error('kelurahan_terluar') is-invalid @enderror" value="{{ old('kelurahan_terluar') }}" placeholder="Masukkan kelurahan terluar">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="tipologi" id="tipologi" class="form-select @error('tipologi') is-invalid @enderror">
                            ...
                            <option value="Dataran Tinggi" {{ old('tipologi') == 'Dataran Tinggi' ? 'selected' : '' }}>Dataran Tinggi</option>
                            <option value="Dataran Rendah" {{ old('tipologi') == 'Dataran Rendah' ? 'selected' : '' }}>Dataran Rendah</option>
                            <option value="Pesisir" {{ old('tipologi') == 'Pesisir' ? 'selected' : '' }}>Pesisir</option>
                            <option value="Pegunungan" {{ old('tipologi') == 'Pegunungan' ? 'selected' : '' }}>Pegunungan</option>
                            <option value="Perbukitan" {{ old('tipologi') == 'Perbukitan' ? 'selected' : '' }}>Perbukitan</option>
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" name="luas" id="luas" class="form-control @error('luas') is-invalid @enderror" value="{{ old('luas') }}" placeholder="0" step="0.01" min="0">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" name="bujur" id="bujur" class="form-control @error('bujur') is-invalid @enderror" value="{{ old('bujur') }}" placeholder="106.123456" step="0.000001" min="-180" max="180">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" name="lintang" id="lintang" class="form-control @error('lintang') is-invalid @enderror" value="{{ old('lintang') }}" placeholder="-6.123456" step="0.000001" min="-90" max="90">
                            <span class="input-group-text">°</span>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" name="ketinggian" id="ketinggian" class="form-control @error('ketinggian') is-invalid @enderror" value="{{ old('ketinggian') }}" placeholder="0" min="0" max="9000">
...
<div class="alert alert-danger mt-3 text-center">
    ...
    <p>Maaf, Anda tidak memiliki izin untuk menambah data desa.</p>
</div>
@endcan
@endsection
