...
@section('title', 'Edit Potensi Kewarganegaraan')

@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">
                 Edit Data Potensi Kewarganegaraan: {{ $pKewarganegaraan->tanggal }}
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('potensi.potensi-sdm.kewarganegaraan.update', $pKewarganegaraan->id) }}" method="POST" id="form-edit-kewarganegaraan">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal" id="tanggal"
                                ...
                                value="{{ old('tanggal', $pKewarganegaraan->tanggal) }}" required>
                            @error('tanggal')
                            ...
                            <select name="kewarganegaraan_id" id="kewarganegaraan_id"
                                ...
                                @foreach ($kewarganegaraans as $kewarganegaraan)
                                    <option value="{{ $kewarganegaraan->id }}"
                                        {{ old('kewarganegaraan_id', $pKewarganegaraan->kewarganegaraan_id) == $kewarganegaraan->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah_laki_laki" id="jumlah_laki_laki"
                                ...
                                value="{{ old('jumlah_laki_laki', $pKewarganegaraan->jumlah_laki_laki) }}" placeholder="Masukkan jumlah laki-laki" required min="0">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah_perempuan" id="jumlah_perempuan"
                                ...
                                value="{{ old('jumlah_perempuan', $pKewarganegaraan->jumlah_perempuan) }}" placeholder="Masukkan jumlah perempuan" required min="0">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-control-plaintext bg-light rounded p-2">
                                ...
                                {{ $pKewarganegaraan->updated_at ? $pKewarganegaraan->updated_at->format('d/m/Y H:i:s') : 'Belum pernah diupdate' }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group d-flex justify-content-end">
                            <a href="{{ route('potensi.potensi-sdm.kewarganegaraan.index') }}" class="btn btn-outline-secondary">
                                <i class="fas fa-times"></i> Batal
                            </a>
                            <a href="{{ route('potensi.potensi-sdm.kewarganegaraan.show', $pKewarganegaraan->id) }}" class="btn btn-secondary">
    ...
    <script>
        $(document).ready(function() {
            ...
            const originalValues = {
                tanggal: "{{ $pKewarganegaraan->tanggal }}",
                kewarganegaraan_id: "{{ $pKewarganegaraan->kewarganegaraan_id }}",
                jumlah_laki_laki: "{{ $pKewarganegaraan->jumlah_laki_laki }}",
                jumlah_perempuan: "{{ $pKewarganegaraan->jumlah_perempuan }}",
                jumlah_total: "{{ $pKewarganegaraan->jumlah_total }}"
            };

            // Form validation
            $('#form-edit-kewarganegaraan').on('submit', function(e) {
                let isValid = true;
