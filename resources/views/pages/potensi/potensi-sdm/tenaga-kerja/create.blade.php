...
@section('title', 'Tambah Potensi Tenaga Kerja')

@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">
                 Tambah Data Potensi Tenaga Kerja
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('potensi.potensi-sdm.tenaga-kerja.store') }}" method="POST" id="form-tenaga-kerja">
                @csrf
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group d-flex justify-content-end">
                            <a href="{{ route('potensi.potensi-sdm.tenaga-kerja.index') }}" class="btn btn-secondary">
...
@push('addon-script')
    <script>
        $(document).ready(function() {
            ...
            // Form validation
            $('#form-tenaga-kerja').on('submit', function(e) {
                let isValid = true;
