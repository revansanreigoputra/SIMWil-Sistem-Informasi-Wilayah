...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('potensi.potensi-sdm.jumlah.store') }}" method="POST" id="form-jumlah">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah_laki" id="jumlah_laki"
                                class="form-control @error('jumlah_laki') is-invalid @enderror" value="{{ old('jumlah_laki') }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah_kk" id="jumlah_kk"
                                class="form-control @error('jumlah_kk') is-invalid @enderror" value="{{ old('jumlah_kk') }}"
                                placeholder="Masukkan jumlah KK" required min="0">
                            @error('jumlah_kk')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah_penduduk" id="jumlah_penduduk"
                                class="form-control @error('jumlah_penduduk') is-invalid @enderror" value="{{ old('jumlah_penduduk') }}"
                                placeholder="Masukkan jumlah penduduk" required min="0">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group d-flex justify-content-end">
                            <a href="{{ route('potensi.potensi-sdm.jumlah.index') }}" class="btn btn-secondary">
