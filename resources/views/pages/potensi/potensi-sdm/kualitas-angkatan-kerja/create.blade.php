...
@section('title', 'Tambah Potensi Kualitas Angkatan Kerja')

@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">
                 Tambah Data Potensi Kualitas Angkatan Kerja
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('potensi.potensi-sdm.kualitas-angkatan-kerja.store') }}" method="POST" id="form-kualitas-angkatan-kerja">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="angkatan_kerja" id="angkatan_kerja"
                                class="form-control @error('angkatan_kerja') is-invalid @enderror" value="{{ old('angkatan_kerja') }}"
                                placeholder="Masukkan jenis angkatan kerja" required>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group d-flex justify-content-end">
                            <a href="{{ route('potensi.potensi-sdm.kualitas-angkatan-kerja.index') }}" class="btn btn-secondary">
...
@push('addon-script')
    <script>
        $(document).ready(function() {
            ...
            // Form validation
            $('#form-kualitas-angkatan-kerja').on('submit', function(e) {
                let isValid = true;
