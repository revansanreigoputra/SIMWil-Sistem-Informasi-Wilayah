...
@section('title', 'Edit Potensi Kualitas Angkatan Kerja')
...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('potensi.potensi-sdm.kualitas-angkatan-kerja.update', $pKualitasAngkatanKerja->id) }}" method="POST" id="form-edit-kualitas-angkatan-kerja">
                @csrf
                @method('PUT')

                {{-- Section: Informasi Potensi Kualitas Angkatan Kerja --}}
                <div class="row">
                    <div class="col-12">
                        <h5 class="text-primary border-bottom pb-2 mb-3">
                            <i class="fas fa-info-circle"></i> Informasi Potensi Kualitas Angkatan Kerja
                        </h5>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal" id="tanggal"
                                ...
                                value="{{ old('tanggal', $pKualitasAngkatanKerja->tanggal) }}" required>
                            @error('tanggal')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah_laki_laki" id="jumlah_laki_laki"
                                ...
                                value="{{ old('jumlah_laki_laki', $pKualitasAngkatanKerja->jumlah_laki_laki) }}" placeholder="Masukkan jumlah laki-laki" required min="0">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah_perempuan" id="jumlah_perempuan"
                                ...
                                value="{{ old('jumlah_perempuan', $pKualitasAngkatanKerja->jumlah_perempuan) }}" placeholder="Masukkan jumlah perempuan" required min="0">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah_total" id="jumlah_total"
                                ...
                                value="{{ old('jumlah_total', $pKualitasAngkatanKerja->jumlah_total) }}" placeholder="Total akan terisi otomatis" required min="0" readonly>
                            @error('jumlah_total')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-control-plaintext bg-light rounded p-2">
                                ...
                                {{ $pKualitasAngkatanKerja->updated_at ? $pKualitasAngkatanKerja->updated_at->format('d/m/Y H:i:s') : 'Belum pernah diupdate' }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group d-flex justify-content-end">
                            <a href="{{ route('potensi.potensi-sdm.kualitas-angkatan-kerja.index') }}" class="btn btn-outline-secondary">
                                <i class="fas fa-times"></i> Batal
                            </a>
                            <a href="{{ route('potensi.potensi-sdm.kualitas-angkatan-kerja.show', $pKualitasAngkatanKerja->id) }}" class="btn btn-secondary">
...
@push('addon-script')
    <script>
        $(document).ready(function() {
            ...
            // Form validation
            $('#form-edit-kualitas-angkatan-kerja').on('submit', function(e) {
                let isValid = true;
