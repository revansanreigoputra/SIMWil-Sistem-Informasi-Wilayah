...
@section('title', 'Tambah Potensi Etnis/Suku')

@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">
                 Tambah Data Potensi Etnis/Suku
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('potensi.potensi-sdm.etnis-suku.store') }}" method="POST" id="form-etnis-suku">
                @csrf
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group d-flex justify-content-end">
                            <a href="{{ route('potensi.potensi-sdm.etnis-suku.index') }}" class="btn btn-secondary">
...
@push('addon-script')
    <script>
        $(document).ready(function() {
            ...
            // Form validation
            $('#form-etnis-suku').on('submit', function(e) {
                let isValid = true;
