...
@section('title', 'Tambah Potensi Pendidikan')

@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">
                 Tambah Data Potensi Pendidikan
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('potensi.potensi-sdm.pendidikan.store') }}" method="POST" id="form-p-pendidikan">
                @csrf
                            ...
                            <select name="id_pendidikan" id="id_pendidikan"
                                ...
                                @foreach ($pendidikans as $pendidikan)
                                    <option value="{{ $pendidikan->id }}"
                                        {{ old('id_pendidikan') == $pendidikan->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="laki" id="laki"
                                class="form-control @error('laki') is-invalid @enderror" value="{{ old('laki') }}"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group d-flex justify-content-end">
                            <a href="{{ route('potensi.potensi-sdm.pendidikan.index') }}" class="btn btn-secondary">
...
@push('addon-script')
    <script>
        $(document).ready(function() {
            ...
            // Form validation
            $('#form-p-pendidikan').on('submit', function(e) {
                let isValid = true;
