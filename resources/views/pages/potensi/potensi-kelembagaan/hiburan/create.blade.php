...
<div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0">
            <i class="bi bi-building-fill-add me-2"></i>Form Tambah Data Usaha Jasa & Hiburan
        </h5>
    </div>
    <div class="card-body p-4">
        <form id="form-hiburan" action="{{ route('potensi.potensi-kelembagaan.hiburan.store') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" name="jenis_produk" id="jenis_produk" class="form-control @error('jenis_produk') is-invalid @enderror" 
                                   value="{{ old('jenis_produk', 0) }}" min="0">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" name="jumlah_tenaga_kerja" id="jumlah_tenaga_kerja" class="form-control @error('jumlah_tenaga_kerja') is-invalid @enderror" 
                                   value="{{ old('jumlah_tenaga_kerja', 0) }}" min="0">
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
                {{-- Tombol Kembali kini dicek dengan permission 'hiburan.index' --}}
                @can('hiburan.index')
...
@else
    {{-- Jika pengguna tidak punya izin 'hiburan.create', tampilkan pesan ini --}}
    <div class="alert alert-danger mt-3">
        <i class="bi bi-exclamation-triangle me-2"></i>
        Maaf, Anda tidak memiliki izin untuk membuat data Usaha Jasa & Hiburan baru.
    </div>
@endcan
@endsection
...
$(document).ready(function() {
    ...
    // Simpan ID jenis usaha yang lama (jika ada dari error validasi)
                ...
                success:function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        $.each(data, function(key, value){
                            // Cek jika ID ini harus dipilih (baik dari old value atau dari edit)
    ...
    $('#kategori_usaha').on('change', function() {
        ...
        // Saat kategori diubah manual, panggil fungsi tanpa ID jenis terpilih
    ...
    if (initialKategoriId) {
        // Jika ada kategori yang sudah terpilih (dari 'old' value),
        // panggil fungsi dan kirimkan 'old' value untuk jenis_usaha_id
        fetchJenisUsaha(initialKategoriId, oldJenisId);
    }
});
</script>
@endpush