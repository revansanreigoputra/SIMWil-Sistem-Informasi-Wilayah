                    ...
                    <div class="col-md-6">
                        ...
                        <select name="kategori_lembaga_ekonomi_id" id="kategori_lembaga" class="form-control" required>
                            ...
                            @foreach($kategori as $item)
                                <option value="{{ $item->id }}" {{ (old('kategori_lembaga_ekonomi_id', $data->kategori_lembaga_ekonomi_id) == $item->id) ? 'selected' : '' }}>
                                    {{ $item->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="jenis_lembaga_ekonomi_id" id="jenis_lembaga" class="form-control" required>
                            ...
                            @foreach($jenis as $item)
                                <option value="{{ $item->id }}" {{ (old('jenis_lembaga_ekonomi_id', $data->jenis_lembaga_ekonomi_id) == $item->id) ? 'selected' : '' }}>
                                    {{ $item->nama }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="card mb-3 p-3 bg-light">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="jumlah_pengurus" class="form-control" value="{{ old('jumlah_pengurus', $data->jumlah_pengurus) }}">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Jumlah Jenis Kegiatan</label>
                        <input type="number" name="jumlah_kegiatan" class="form-control" value="{{ old('jumlah_kegiatan', $data->jumlah_kegiatan) }}">
                    </div>
                </div>
            </div>
