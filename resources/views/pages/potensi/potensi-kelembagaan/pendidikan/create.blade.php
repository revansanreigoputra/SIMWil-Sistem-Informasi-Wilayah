...
@section('content')
{{-- Memeriksa apakah pengguna memiliki izin 'pendidikan.create' --}}
@can('pendidikan.create')
<div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0">
            <i class="bi bi-building-add me-2"></i>Form Tambah Data Lembaga Pendidikan
        </h5>
    </div>
        ...
        <form action="{{ route('potensi.potensi-kelembagaan.pendidikan.store') }}" method="POST">
            ...
            <div class="mb-2 border rounded-3 p-4 bg-light">
                ...
                <div class="row g-3">
                    ...
                    {{-- Kategori Sekolah --}}
                    <div class="col-md-6">
                        <label for="kategori" class="form-label fw-semibold">Kategori Sekolah <span class="text-danger">*</span></label>
                        <select name="kategori_id" id="kategori" class="form-select @error('kategori_id') is-invalid @enderror" required>
                    ...
                    <div class="col-md-6">
                        <label for="jenisSekolah" class="form-label fw-semibold">Tingkatan / Jenis Sekolah <span class="text-danger">*</span></label>
                        <select name="jenis_sekolah_id" id="jenisSekolah" class="form-select @error('jenis_sekolah_id') is-invalid @enderror" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                            ...
                            <option value="Terakreditasi" {{ old('status') == 'Terakreditasi' ? 'selected' : '' }}>Terakreditasi</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                             <input type="number" name="jumlah_negeri" id="jumlah_negeri" class="form-control" value="{{ old('jumlah_negeri', 0) }}" min="0">
                    ...
                    <div class="col-md-4">
                        <label for="jumlah_swasta" class="form-label fw-semibold">Jumlah Swasta</label>
                         <div class="input-group">
                            <input type="number" name="jumlah_swasta" id="jumlah_swasta" class="form-control" value="{{ old('jumlah_swasta', 0) }}" min="0">
                            <span class="input-group-text">Gedung</span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" name="jumlah_dimiliki_desa" id="jumlah_dimiliki_desa" class="form-control" value="{{ old('jumlah_dimiliki_desa', 0) }}" min="0">
                            <span class="input-group-text">Gedung</span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" name="jumlah" id="jumlah" class="form-control" value="{{ old('jumlah', 0) }}" min="0">
                            <span class="input-group-text">Gedung</span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" name="jumlah_pengajar" id="jumlah_pengajar" class="form-control" value="{{ old('jumlah_pengajar', 0) }}" min="0">
...
@else
    {{-- Jika pengguna tidak punya izin 'pendidikan.create', tampilkan pesan ini --}}
    <div class="alert alert-danger mt-3">
        <i class="bi bi-exclamation-triangle me-2"></i>
        Maaf, Anda tidak memiliki izin untuk membuat data Lembaga Pendidikan baru.
    </div>
@endcan
@endsection
...
$(document).ready(function() {
    ...
    const oldJenisId = "{{ old('jenis_sekolah_id') }}";

    function fetchJenisPendidikan(kategoriId, selectedJenisId = null) {
        const $jenisDropdown = $('#jenisSekolah');
        if (!kategoriId) {
    ...
    // Auto-load jika ada 'old' value untuk kategori (setelah validation error)
    const initialKategoriId = $('#kategori').val();
    if (initialKategoriId) {
        fetchJenisPendidikan(initialKategoriId, oldJenisId);
    }
});
</script>
@endpush