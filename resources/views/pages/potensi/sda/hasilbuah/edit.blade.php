...
@section('title', 'Edit Data Hasil Produksi Buah')
    ...
    <div class="card shadow-sm">
        <div class="card-header text-dark">
            <h5 class="card-title mb-0">
                ...
                Edit Data Hasil Produksi Buah
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('hasilbuah.update', $hasilbuah->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                ...
                                value="{{ old('tanggal', $hasilbuah->tanggal->format('Y-m-d')) }}" required>
                            @error('tanggal')
                            ...
                            <select class="form-select @error('komoditas_buah_id') is-invalid @enderror"
                                ...
                                @foreach ($komoditasBuahs as $komoditas)
                                    <option value="{{ $komoditas->id }}"
                                        {{ old('komoditas_buah_id', $hasilbuah->komoditas_buah_id) == $komoditas->id ? 'selected' : '' }}>
                                        {{ $komoditas->nama }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="luas_produksi"
                                name="luas_produksi" value="{{ old('luas_produksi', $hasilbuah->luas_produksi) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hasil_produksi"
                                name="hasil_produksi" value="{{ old('hasil_produksi', $hasilbuah->hasil_produksi) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="dijual_langsung_konsumen">
                                <option value="Tidak"
                                    {{ old('dijual_langsung_konsumen', $hasilbuah->dijual_langsung_konsumen) == 'Tidak' ? 'selected' : '' }}>
                                    Tidak</option>
                                <option value="Ya"
                                    {{ old('dijual_langsung_konsumen', $hasilbuah->dijual_langsung_konsumen) == 'Ya' ? 'selected' : '' }}>
                                    Ya</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="dijual_ke_pasar">
                                <option value="Tidak"
                                    {{ old('dijual_ke_pasar', $hasilbuah->dijual_ke_pasar) == 'Tidak' ? 'selected' : '' }}>
                                    Tidak</option>
                                <option value="Ya"
                                    {{ old('dijual_ke_pasar', $hasilbuah->dijual_ke_pasar) == 'Ya' ? 'selected' : '' }}>
                                    Ya</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="dijual_melalui_kud">
                                <option value="Tidak"
                                    {{ old('dijual_melalui_kud', $hasilbuah->dijual_melalui_kud) == 'Tidak' ? 'selected' : '' }}>
                                    Tidak</option>
                                <option value="Ya"
                                    {{ old('dijual_melalui_kud', $hasilbuah->dijual_melalui_kud) == 'Ya' ? 'selected' : '' }}>
                                    Ya</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="dijual_melalui_tengkulak">
                                <option value="Tidak"
                                    {{ old('dijual_melalui_tengkulak', $hasilbuah->dijual_melalui_tengkulak) == 'Tidak' ? 'selected' : '' }}>
                                    Tidak</option>
                                <option value="Ya"
                                    {{ old('dijual_melalui_tengkulak', $hasilbuah->dijual_melalui_tengkulak) == 'Ya' ? 'selected' : '' }}>
                                    Ya</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="dijual_melalui_pengecer">
                                <option value="Tidak"
                                    {{ old('dijual_melalui_pengecer', $hasilbuah->dijual_melalui_pengecer) == 'Tidak' ? 'selected' : '' }}>
                                    Tidak</option>
                                <option value="Ya"
                                    {{ old('dijual_melalui_pengecer', $hasilbuah->dijual_melalui_pengecer) == 'Ya' ? 'selected' : '' }}>
                                    Ya</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="dijual_ke_lumbung_desa">
                                <option value="Tidak"
                                    {{ old('dijual_ke_lumbung_desa', $hasilbuah->dijual_ke_lumbung_desa) == 'Tidak' ? 'selected' : '' }}>
                                    Tidak</option>
                                <option value="Ya"
                                    {{ old('dijual_ke_lumbung_desa', $hasilbuah->dijual_ke_lumbung_desa) == 'Ya' ? 'selected' : '' }}>
                                    Ya</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="tidak_dijual">
                                <option value="Tidak"
                                    {{ old('tidak_dijual', $hasilbuah->tidak_dijual) == 'Tidak' ? 'selected' : '' }}>
                                    Tidak</option>
                                <option value="Ya"
                                    {{ old('tidak_dijual', $hasilbuah->tidak_dijual) == 'Ya' ? 'selected' : '' }}>Ya
                                </option>
                            </select>
                        </div>
                    </div>
