...
@section('title', 'Tambah Data Kepemilikan Lahan Buah')
    ...
    <div class="card shadow-sm">
        <div class="card-header text-dark">
            <h5 class="card-title mb-0">
                ...
                Tambah Data Kepemilikan Lahan Buah
            </h5>
        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="memiliki_kurang_10" class="form-label">Memiliki < 10</label>
                                    <input type="number" step="0.01" class="form-control" id="memiliki_kurang_10"
                                        name="memiliki_kurang_10" value="{{ old('memiliki_kurang_10', 0) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="memiliki_10_50" class="form-label">Memiliki 10-50</label>
                            <input type="number" step="0.01" class="form-control" id="memiliki_10_50"
                                name="memiliki_10_50" value="{{ old('memiliki_10_50', 0) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="memiliki_50_100" class="form-label">Memiliki 50-100</label>
                            <input type="number" step="0.01" class="form-control" id="memiliki_50_100"
                                name="memiliki_50_100" value="{{ old('memiliki_50_100', 0) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="memiliki_100_500" class="form-label">Memiliki 100-500</label>
                            <input type="number" step="0.01" class="form-control" id="memiliki_100_500"
                                name="memiliki_100_500" value="{{ old('memiliki_100_500', 0) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="memiliki_500_1000" class="form-label">Memiliki 500-1000</label>
                            <input type="number" step="0.01" class="form-control" id="memiliki_500_1000"
                                name="memiliki_500_1000" value="{{ old('memiliki_500_1000', 0) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="memiliki_lebih_1000" class="form-label">Memiliki > 1000</label>
                            <input type="number" step="0.01" class="form-control" id="memiliki_lebih_1000"
                                name="memiliki_lebih_1000" value="{{ old('memiliki_lebih_1000', 0) }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="jumlah_keluarga_petani_buah"
                                name="jumlah_keluarga_petani_buah" value="{{ old('jumlah_keluarga_petani_buah', 0) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group gap-2">
                                <a href="{{ route('kepemilikan.index') }}" class="btn btn-outline-secondary rounded">
                                    Kembali
                                </a>
