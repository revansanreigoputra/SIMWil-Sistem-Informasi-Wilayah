...
@section('title', 'Edit Data Kebisingan')
    ...
    <div class="card shadow-sm">
        <div class="card-header text-dark">
            <h5 class="card-title mb-0">
                ...
                Edit Data Kebisingan
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('kebisingan.update', $kebisingan->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal"
                                name="tanggal" value="{{ old('tanggal', $kebisingan->tanggal->format('Y-m-d')) }}" required>
                            @error('tanggal')
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('tingkat_kebisingan') is-invalid @enderror" id="tingkat_kebisingan"
                        ...
                        <option value="ringan" {{ old('tingkat_kebisingan', $kebisingan->tingkat_kebisingan) == 'ringan' ? 'selected' : '' }}>Ringan</option>
                        <option value="sedang" {{ old('tingkat_kebisingan', $kebisingan->tingkat_kebisingan) == 'sedang' ? 'selected' : '' }}>Sedang</option>
                        <option value="tinggi" {{ old('tingkat_kebisingan', $kebisingan->tingkat_kebisingan) == 'tinggi' ? 'selected' : '' }}>Tinggi</option>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('sumber_kebisingan') is-invalid @enderror"
                        id="sumber_kebisingan" name="sumber_kebisingan" value="{{ old('sumber_kebisingan', $kebisingan->sumber_kebisingan) }}" required>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('ekses_dampak_kebisingan') is-invalid @enderror"
                        ...
                        <option value="ya" {{ old('ekses_dampak_kebisingan', $kebisingan->ekses_dampak_kebisingan) == 'ya' ? 'selected' : '' }}>Ya</option>
                        <option value="tidak" {{ old('ekses_dampak_kebisingan', $kebisingan->ekses_dampak_kebisingan) == 'tidak' ? 'selected' : '' }}>Tidak</option>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('efek_terhadap_penduduk') is-invalid @enderror" id="efek_terhadap_penduduk"
                        name="efek_terhadap_penduduk" rows="3">{{ old('efek_terhadap_penduduk', $kebisingan->efek_terhadap_penduduk) }}</textarea>
