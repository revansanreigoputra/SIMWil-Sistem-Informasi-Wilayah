...
@section('title', 'Edit Data Produksi Ternak')
    ...
    <div class="card shadow-sm">
        <div class="card-header text-dark">
            <h5 class="card-title mb-0">
                ...
                Edit Data Produksi Ternak
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('produksi-ternak.update', $produksiTernak->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal"
                                name="tanggal" value="{{ old('tanggal', $produksiTernak->tanggal->format('Y-m-d')) }}" required>
                            @error('tanggal')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('jenis_produksi_ternak_id') is-invalid @enderror" id="jenis_produksi_ternak_id"
                                ...
                                @foreach ($jenisProduksiTernaks as $jenis)
                                    <option value="{{ $jenis->id }}" {{ old('jenis_produksi_ternak_id', $produksiTernak->jenis_produksi_ternak_id) == $jenis->id ? 'selected' : '' }}>
                                        {{ $jenis->nama }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('hasil_produksi') is-invalid @enderror" id="hasil_produksi"
                                name="hasil_produksi" value="{{ old('hasil_produksi', $produksiTernak->hasil_produksi) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('satuan_produksi_ternak_id') is-invalid @enderror" id="satuan_produksi_ternak_id"
                                ...
                                @foreach ($satuanProduksiTernaks as $satuan)
                                    <option value="{{ $satuan->id }}" {{ old('satuan_produksi_ternak_id', $produksiTernak->satuan_produksi_ternak_id) == $satuan->id ? 'selected' : '' }}>
                                        {{ $satuan->nama }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('nilai_produksi_tahun_ini') is-invalid @enderror" id="nilai_produksi_tahun_ini"
                                name="nilai_produksi_tahun_ini" value="{{ old('nilai_produksi_tahun_ini', $produksiTernak->nilai_produksi_tahun_ini) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('nilai_bahan_baku_yang_digunakan') is-invalid @enderror" id="nilai_bahan_baku_yang_digunakan"
                                name="nilai_bahan_baku_yang_digunakan" value="{{ old('nilai_bahan_baku_yang_digunakan', $produksiTernak->nilai_bahan_baku_yang_digunakan) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('nilai_bahan_penolong_yang_digunakan') is-invalid @enderror" id="nilai_bahan_penolong_yang_digunakan"
                                name="nilai_bahan_penolong_yang_digunakan" value="{{ old('nilai_bahan_penolong_yang_digunakan', $produksiTernak->nilai_bahan_penolong_yang_digunakan) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('jumlah_ternak_tahun_ini') is-invalid @enderror" id="jumlah_ternak_tahun_ini"
                                name="jumlah_ternak_tahun_ini" value="{{ old('jumlah_ternak_tahun_ini', $produksiTernak->jumlah_ternak_tahun_ini) }}">
