...
@section('title', 'Tambah Data Deposit dan Produksi Galian')
    ...
    <div class="card shadow-sm">
        <div class="card-header text-dark">
            <h5 class="card-title mb-0">
                ...
                Tambah Data Deposit Produksi Galian
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('deposit-produksi-galian.store') }}" method="POST">
                @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('komoditas_galian_id') is-invalid @enderror" id="komoditas_galian_id"
                                ...
                                @foreach ($komoditasGalians as $komoditas)
                                    <option value="{{ $komoditas->id }}" {{ old('komoditas_galian_id') == $komoditas->id ? 'selected' : '' }}>
                                        {{ $komoditas->nama }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status"
                                ...
                                <option value="ada tapi belum produktif" {{ old('status') == 'ada tapi belum produktif' ? 'selected' : '' }}>Ada tapi belum produktif</option>
                                <option value="ada dan sudah produktif" {{ old('status') == 'ada dan sudah produktif' ? 'selected' : '' }}>Ada dan sudah produktif</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('hasil_produksi') is-invalid @enderror" id="hasil_produksi"
                                ...
                                <option value="kecil" {{ old('hasil_produksi') == 'kecil' ? 'selected' : '' }}>Kecil</option>
                                <option value="sedang" {{ old('hasil_produksi') == 'sedang' ? 'selected' : '' }}>Sedang</option>
                                <option value="besar" {{ old('hasil_produksi') == 'besar' ? 'selected' : '' }}>Besar</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('dijual_ke_perusahaan') is-invalid @enderror" id="dijual_ke_perusahaan"
                                ...
                                <option value="tidak" {{ old('dijual_ke_perusahaan') == 'tidak' ? 'selected' : '' }}>Tidak</option>
                                <option value="ya" {{ old('dijual_ke_perusahaan') == 'ya' ? 'selected' : '' }}>Ya</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('kepemilikan') is-invalid @enderror" id="kepemilikan"
                                ...
                                <option value="pemerintah" {{ old('kepemilikan') == 'pemerintah' ? 'selected' : '' }}>Pemerintah</option>
                                <option value="swasta" {{ old('kepemilikan') == 'swasta' ? 'selected' : '' }}>Swasta</option>
                                <option value="perorangan" {{ old('kepemilikan') == 'perorangan' ? 'selected' : '' }}>Perorangan</option>
                                <option value="adat" {{ old('kepemilikan') == 'adat' ? 'selected' : '' }}>Adat</option>
