...
@section('title', 'Edit Data Jenis Lahan')
    ...
    <div class="card shadow-sm">
        <div class="card-header text-dark">
            <h5 class="card-title mb-0">
                ...
                Edit Data Jenis Lahan
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('jlahan.update', $jlahan->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal"
                                name="tanggal" value="{{ old('tanggal', $jlahan->tanggal->format('Y-m-d')) }}" required>
                            @error('tanggal')
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="sawah_irigasi_teknis"
                                name="sawah_irigasi_teknis"
                                value="{{ old('sawah_irigasi_teknis', $jlahan->sawah_irigasi_teknis) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="sawah_irigasi_setengah_teknis"
                                name="sawah_irigasi_setengah_teknis"
                                value="{{ old('sawah_irigasi_setengah_teknis', $jlahan->sawah_irigasi_setengah_teknis) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="sawah_tadah_hujan"
                                name="sawah_tadah_hujan" value="{{ old('sawah_tadah_hujan', $jlahan->sawah_tadah_hujan) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="sawah_pasang_surut"
                                name="sawah_pasang_surut"
                                value="{{ old('sawah_pasang_surut', $jlahan->sawah_pasang_surut) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="luas_tanah_sawah"
                                name="luas_tanah_sawah" value="{{ old('luas_tanah_sawah', $jlahan->luas_tanah_sawah) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="tanah_rawa" name="tanah_rawa"
                                value="{{ old('tanah_rawa', $jlahan->tanah_rawa) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="pasang_surut" name="pasang_surut"
                                value="{{ old('pasang_surut', $jlahan->pasang_surut) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="lahan_gambut"
                                name="lahan_gambut" value="{{ old('lahan_gambut', $jlahan->lahan_gambut) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="situ_waduk_danau"
                                name="situ_waduk_danau" value="{{ old('situ_waduk_danau', $jlahan->situ_waduk_danau) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="luas_tanah_basah"
                                name="luas_tanah_basah" value="{{ old('luas_tanah_basah', $jlahan->luas_tanah_basah) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="tanah_ladang"
                                name="tanah_ladang" value="{{ old('tanah_ladang', $jlahan->tanah_ladang) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="pemukiman" name="pemukiman"
                                value="{{ old('pemukiman', $jlahan->pemukiman) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="pekarangan" name="pekarangan"
                                value="{{ old('pekarangan', $jlahan->pekarangan) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="luas_tanah_kering"
                                name="luas_tanah_kering"
                                value="{{ old('luas_tanah_kering', $jlahan->luas_tanah_kering) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="perkebunan_rakyat"
                                name="perkebunan_rakyat"
                                value="{{ old('perkebunan_rakyat', $jlahan->perkebunan_rakyat) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="perkebunan_negara"
                                name="perkebunan_negara"
                                value="{{ old('perkebunan_negara', $jlahan->perkebunan_negara) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="perkebunan_swasta"
                                name="perkebunan_swasta"
                                value="{{ old('perkebunan_swasta', $jlahan->perkebunan_swasta) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="perkebunan_perseorangan"
                                name="perkebunan_perseorangan"
                                value="{{ old('perkebunan_perseorangan', $jlahan->perkebunan_perseorangan) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="luas_tanah_perkebunan"
                                name="luas_tanah_perkebunan"
                                value="{{ old('luas_tanah_perkebunan', $jlahan->luas_tanah_perkebunan) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="tanah_bengkok"
                                name="tanah_bengkok" value="{{ old('tanah_bengkok', $jlahan->tanah_bengkok) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="tanah_titi_sara"
                                name="tanah_titi_sara" value="{{ old('tanah_titi_sara', $jlahan->tanah_titi_sara) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="kebun_desa" name="kebun_desa"
                                value="{{ old('kebun_desa', $jlahan->kebun_desa) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="sawah_desa" name="sawah_desa"
                                value="{{ old('sawah_desa', $jlahan->sawah_desa) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="kas_desa" name="kas_desa"
                                value="{{ old('kas_desa', $jlahan->kas_desa) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="lokasi_tanah_kas_desa" name="lokasi_tanah_kas_desa">
                                ...
                                <option value="Di dalam desa"
                                    {{ old('lokasi_tanah_kas_desa', $jlahan->lokasi_tanah_kas_desa) == 'Di dalam desa' ? 'selected' : '' }}>
                                    Di dalam desa</option>
                                <option value="Di luar desa"
                                    {{ old('lokasi_tanah_kas_desa', $jlahan->lokasi_tanah_kas_desa) == 'Di luar desa' ? 'selected' : '' }}>
                                    Di luar desa</option>
                                <option value="Sebagian di luar"
                                    {{ old('lokasi_tanah_kas_desa', $jlahan->lokasi_tanah_kas_desa) == 'Sebagian di luar' ? 'selected' : '' }}>
                                    Sebagian di luar</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="lapangan_olahraga"
                                name="lapangan_olahraga"
                                value="{{ old('lapangan_olahraga', $jlahan->lapangan_olahraga) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="perkantoran_pemerintahan"
                                name="perkantoran_pemerintahan"
                                value="{{ old('perkantoran_pemerintahan', $jlahan->perkantoran_pemerintahan) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="ruang_publik_taman"
                                name="ruang_publik_taman"
                                value="{{ old('ruang_publik_taman', $jlahan->ruang_publik_taman) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="bangunan_pendidikan"
                                name="bangunan_pendidikan"
                                value="{{ old('bangunan_pendidikan', $jlahan->bangunan_pendidikan) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="pertokoan" name="pertokoan"
                                value="{{ old('pertokoan', $jlahan->pertokoan) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="fasilitas_pasar"
                                name="fasilitas_pasar" value="{{ old('fasilitas_pasar', $jlahan->fasilitas_pasar) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="terminal" name="terminal"
                                value="{{ old('terminal', $jlahan->terminal) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="daerah_tangkapan_air"
                                name="daerah_tangkapan_air"
                                value="{{ old('daerah_tangkapan_air', $jlahan->daerah_tangkapan_air) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="usaha_perikanan"
                                name="usaha_perikanan" value="{{ old('usaha_perikanan', $jlahan->usaha_perikanan) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="aliran_stutet"
                                name="aliran_stutet" value="{{ old('aliran_stutet', $jlahan->aliran_stutet) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="luas_tanah_fasilitas_umum"
                                name="luas_tanah_fasilitas_umum"
                                value="{{ old('luas_tanah_fasilitas_umum', $jlahan->luas_tanah_fasilitas_umum) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hutan_lindung"
                                name="hutan_lindung" value="{{ old('hutan_lindung', $jlahan->hutan_lindung) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hutan_produksi_tetap"
                                ...
                                value="{{ old('hutan_produksi_tetap', $jlahan->hutan_produksi_tetap) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hutan_produksi_terbatas"
                                ...
                                value="{{ old('hutan_produksi_terbatas', $jlahan->hutan_produksi_terbatas) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hutan_produksi"
                                name="hutan_produksi" value="{{ old('hutan_produksi', $jlahan->hutan_produksi) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hutan_konservasi"
                                name="hutan_konservasi" value="{{ old('hutan_konservasi', $jlahan->hutan_konservasi) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hutan_adat" name="hutan_adat"
                                value="{{ old('hutan_adat', $jlahan->hutan_adat) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hutan_asli" name="hutan_asli"
                                value="{{ old('hutan_asli', $jlahan->hutan_asli) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hutan_sekunder"
                                name="hutan_sekunder" value="{{ old('hutan_sekunder', $jlahan->hutan_sekunder) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hutan_buatan"
                                name="hutan_buatan" value="{{ old('hutan_buatan', $jlahan->hutan_buatan) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hutan_mangrove"
                                name="hutan_mangrove" value="{{ old('hutan_mangrove', $jlahan->hutan_mangrove) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="suaka_alam" name="suaka_alam"
                                value="{{ old('suaka_alam', $jlahan->suaka_alam) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="suaka_margasatwa"
                                name="suaka_margasatwa" value="{{ old('suaka_margasatwa', $jlahan->suaka_margasatwa) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hutan_suaka"
                                name="hutan_suaka" value="{{ old('hutan_suaka', $jlahan->hutan_suaka) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hutan_rakyat"
                                name="hutan_rakyat" value="{{ old('hutan_rakyat', $jlahan->hutan_rakyat) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="luas_tanah_hutan"
                                name="luas_tanah_hutan" value="{{ old('luas_tanah_hutan', $jlahan->luas_tanah_hutan) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="luas_desa" name="luas_desa"
                                value="{{ old('luas_desa', $jlahan->luas_desa) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="total_luas_entri_data"
                                name="total_luas_entri_data"
                                value="{{ old('total_luas_entri_data', $jlahan->total_luas_entri_data) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="selisih_luas"
                                name="selisih_luas" value="{{ old('selisih_luas', $jlahan->selisih_luas) }}">
                        </div>
                    </div>
                </div>
