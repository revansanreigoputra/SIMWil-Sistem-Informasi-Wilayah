...
@section('title', 'Edit Data Hasil Produksi Kebun')
    ...
    <div class="card shadow-sm">
        <div class="card-header text-dark">
            <h5 class="card-title mb-0">
                ...
                Edit Data Hasil Produksi Kebun
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('hasilkebun.update', $hasilkebun->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                ...
                                value="{{ old('tanggal', $hasilkebun->tanggal->format('Y-m-d')) }}" required>
                            @error('tanggal')
                            ...
                            <select class="form-select @error('komoditas_perkebunan_id') is-invalid @enderror"
                                ...
                                @foreach ($komoditas as $item)
                                    <option value="{{ $item->id }}"
                                        {{ old('komoditas_perkebunan_id', $hasilkebun->komoditas_perkebunan_id) == $item->id ? 'selected' : '' }}>
                                        {{ $item->nama }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="luas_perkebunan_swasta_negara"
                                name="luas_perkebunan_swasta_negara" value="{{ old('luas_perkebunan_swasta_negara', $hasilkebun->luas_perkebunan_swasta_negara) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hasil_perkebunan_swasta_negara"
                                name="hasil_perkebunan_swasta_negara" value="{{ old('hasil_perkebunan_swasta_negara', $hasilkebun->hasil_perkebunan_swasta_negara) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="luas_perkebunan_rakyat"
                                name="luas_perkebunan_rakyat" value="{{ old('luas_perkebunan_rakyat', $hasilkebun->luas_perkebunan_rakyat) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="hasil_perkebunan_rakyat"
                                name="hasil_perkebunan_rakyat" value="{{ old('hasil_perkebunan_rakyat', $hasilkebun->hasil_perkebunan_rakyat) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="harga_lokal" name="harga_lokal"
                                value="{{ old('harga_lokal', $hasilkebun->harga_lokal) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="nilai_produksi_tahun_ini"
                                name="nilai_produksi_tahun_ini" value="{{ old('nilai_produksi_tahun_ini', $hasilkebun->nilai_produksi_tahun_ini) }}">
                        </div>
                    </div>
                     <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="saldo_produksi"
                                name="saldo_produksi" value="{{ old('saldo_produksi', $hasilkebun->saldo_produksi) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="biaya_pemupukan"
                                name="biaya_pemupukan" value="{{ old('biaya_pemupukan', $hasilkebun->biaya_pemupukan) }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="biaya_bibit" name="biaya_bibit"
                                value="{{ old('biaya_bibit', $hasilkebun->biaya_bibit) }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="biaya_obat" name="biaya_obat"
                                value="{{ old('biaya_obat', $hasilkebun->biaya_obat) }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="biaya_lainnya"
                                name="biaya_lainnya" value="{{ old('biaya_lainnya', $hasilkebun->biaya_lainnya) }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="dijual_langsung_ke_konsumen">
                                <option value="Tidak" {{ old('dijual_langsung_ke_konsumen', $hasilkebun->dijual_langsung_ke_konsumen) == 'Tidak' ? 'selected' : '' }}>
                                    Tidak</option>
                                <option value="Ya" {{ old('dijual_langsung_ke_konsumen', $hasilkebun->dijual_langsung_ke_konsumen) == 'Ya' ? 'selected' : '' }}>Ya
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="dijual_melalui_kud">
                                <option value="Tidak" {{ old('dijual_melalui_kud', $hasilkebun->dijual_melalui_kud) == 'Tidak' ? 'selected' : '' }}>Tidak
                                </option>
                                <option value="Ya" {{ old('dijual_melalui_kud', $hasilkebun->dijual_melalui_kud) == 'Ya' ? 'selected' : '' }}>Ya</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="dijual_melalui_tengkulak">
                                <option value="Tidak" {{ old('dijual_melalui_tengkulak', $hasilkebun->dijual_melalui_tengkulak) == 'Tidak' ? 'selected' : '' }}>
                                    Tidak</option>
                                <option value="Ya" {{ old('dijual_melalui_tengkulak', $hasilkebun->dijual_melalui_tengkulak) == 'Ya' ? 'selected' : '' }}>Ya
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="dijual_melalui_pengecer">
                                <option value="Tidak" {{ old('dijual_melalui_pengecer', $hasilkebun->dijual_melalui_pengecer) == 'Tidak' ? 'selected' : '' }}>
                                    Tidak</option>
                                <option value="Ya" {{ old('dijual_melalui_pengecer', $hasilkebun->dijual_melalui_pengecer) == 'Ya' ? 'selected' : '' }}>Ya
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="dijual_ke_lumbung_desa">
                                <option value="Tidak" {{ old('dijual_ke_lumbung_desa', $hasilkebun->dijual_ke_lumbung_desa) == 'Tidak' ? 'selected' : '' }}>
                                    Tidak</option>
                                <option value="Ya" {{ old('dijual_ke_lumbung_desa', $hasilkebun->dijual_ke_lumbung_desa) == 'Ya' ? 'selected' : '' }}>Ya
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="tidak_dijual">
                                <option value="Tidak" {{ old('tidak_dijual', $hasilkebun->tidak_dijual) == 'Tidak' ? 'selected' : '' }}>Tidak
                                </option>
                                <option value="Ya" {{ old('tidak_dijual', $hasilkebun->tidak_dijual) == 'Ya' ? 'selected' : '' }}>Ya</option>
                            </select>
                        </div>
                    </div>
                </div>
