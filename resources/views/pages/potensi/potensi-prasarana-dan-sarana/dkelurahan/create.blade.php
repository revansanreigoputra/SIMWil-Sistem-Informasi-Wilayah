...
@section('title', 'Tambah Data Desa/Kelurahan')
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex align-items-center">
                            ...
                            <h4 class="card-title mb-0">Tambah Data Desa/Kelurahan</h4>
                        </div>
                    </div>
                </div>

                <form action="{{ route('potensi.potensi-prasarana-dan-sarana.prasarana-dkelurahan.store') }}" method="POST">
                    @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('gedung_kantor') is-invalid @enderror"
                                            ...
                                            <option value="ada" {{ old('gedung_kantor') == 'ada' ? 'selected' : '' }}>Ada
                                            </option>
                                            <option value="tidak ada"
                                                {{ old('gedung_kantor') == 'tidak ada' ? 'selected' : '' }}>Tidak Ada
                                            </option>
                                        </select>
                                        @error('gedung_kantor')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            name="ruang_kerja" value="{{ old('ruang_kerja', 0) }}" min="0"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-select @error($field) is-invalid @enderror"
                                                id="{{ $field }}" name="{{ $field }}">
                                                <option value="">-- Pilih Status --</option>
                                                <option value="ada" {{ old($field) == 'ada' ? 'selected' : '' }}>Ada
                                                </option>
                                                <option value="tidak ada"
                                                    {{ old($field) == 'tidak ada' ? 'selected' : '' }}>Tidak Ada</option>
                                            </select>
                                            @error($field)
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('kondisi') is-invalid @enderror" id="kondisi"
                                            ...
                                            <option value="buruk" {{ old('kondisi') == 'buruk' ? 'selected' : '' }}>Buruk
                                            </option>
                                            <option value="rusak_ringan"
                                                {{ old('kondisi') == 'rusak_ringan' ? 'selected' : '' }}>Rusak Ringan
                                            </option>
                                            <option value="rusak_berat"
                                                {{ old('kondisi') == 'rusak_berat' ? 'selected' : '' }}>Rusak Berat
                                            </option>
                                        </select>
                                        @error('kondisi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('tahun_pembangunan') }}" min="1900"
                                            max="{{ date('Y') }}" placeholder="Contoh: {{ date('Y') }}">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-select @error($field) is-invalid @enderror"
                                                ...
                                                <option value="ada_dan_terisi"
                                                    {{ old($field) == 'ada_dan_terisi' ? 'selected' : '' }}>Ada dan Terisi
                                                </option>
                                                <option value="ada_dan_tidak_terisi"
                                                    {{ old($field) == 'ada_dan_tidak_terisi' ? 'selected' : '' }}>Ada dan
                                                    Tidak Terisi</option>
                                                <option value="tidak_ada"
                                                    {{ old($field) == 'tidak_ada' ? 'selected' : '' }}>Tidak Ada</option>
                                            </select>
                                            @error($field)
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('pos_kamling') is-invalid @enderror"
                                            ...
                                            <option value="">-- Pilih Status --</option>
                                            <option value="ada" {{ old('pos_kamling') == 'ada' ? 'selected' : '' }}>Ada
                                            </option>
                                            <option value="tidak ada"
                                                {{ old('pos_kamling') == 'tidak ada' ? 'selected' : '' }}>Tidak Ada
                                            </option>
                                        </select>
                                        @error('pos_kamling')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('jumlah_pos_kamling', 0) }}" min="0"
                                            placeholder="Jumlah pos">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <textarea class="form-control @error('fasilitas_lainnya') is-invalid @enderror" id="fasilitas_lainnya"
                                    name="fasilitas_lainnya" rows="4" placeholder="Sebutkan fasilitas lainnya yang belum tercantum di atas...">{{ old('fasilitas_lainnya') }}</textarea>
