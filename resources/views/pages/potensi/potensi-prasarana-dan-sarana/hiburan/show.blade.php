...
@section('title', 'Detail Data Prasarana Hiburan')
        ...
        <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <h3 class="mb-0 fw-bold text-dark">
                            {{ $prasaranahiburan->desa->nama_desa }}
                        </h3>
                        <p class="mb-0 text-dark">{{ $prasaranahiburan->tanggal?->format('d F Y') ?? '-' }}</p>
                    </div>
                </div>
            </div>

            <div class="card-body p-4">
                <!-- Data Prasarana Hiburan Section -->
                <div class="mb-4">
                    <div class="d-flex align-items-center mb-3">
                        <div class="bg-primary bg-opacity-10 rounded-2 p-2 me-2">
                            <i class="fas fa-building text-primary"></i>
                        </div>
                        <h6 class="mb-0 fw-bold text-dark">Data Prasarana Hiburan</h6>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <label class="text-muted small mb-1 d-block">Jenis Prasarana Hiburan</label>
                                            <h6 class="mb-0 fw-bold text-dark">
                                                {{ $prasaranahiburan->jphiburan?->nama ?? '-' }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <h6 class="mb-0 fw-bold text-dark">
                                                {{ number_format($prasaranahiburan->jumlah) }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center p-3 bg-light rounded-3">
                                ...
                                <div>
                                    ...
                                    <span
                                        class="fw-semibold text-dark">{{ $prasaranahiburan->created_at?->format('d M Y, H:i') ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center p-3 bg-light rounded-3">
                                ...
                                <div>
                                    ...
                                    <span
                                        class="fw-semibold text-dark">{{ $prasaranahiburan->updated_at?->format('d M Y, H:i') ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-footer bg-white border-top py-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    @can('hiburan.update')
                        <a href="{{ route('potensi.potensi-prasarana-dan-sarana.hiburan.edit', $prasaranahiburan->id) }}"
