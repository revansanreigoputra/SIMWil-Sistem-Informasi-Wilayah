...
@section('title', 'Edit Data Sarana Transportasi')
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-warning text-white">
                        <div class="d-flex align-items-center">
                            ...
                            <h4 class="card-title mb-0">Edit Data Sarana Transportasi</h4>
                        </div>
                    </div>
                </div>

                <form action="{{ route('potensi.potensi-prasarana-dan-sarana.angkutan.update', $saranaTransportasi->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('desa_id') is-invalid @enderror" id="desa_id"
                                            ...
                                            @foreach ($desas as $desa)
                                                <option value="{{ $desa->id }}" {{ old('desa_id', $saranaTransportasi->desa_id) == $desa->id ? 'selected' : '' }}>
                                                    {{ $desa->nama_desa }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                            ...
                                            value="{{ old('tanggal', $saranaTransportasi->tanggal->format('Y-m-d')) }}"
                                            required>
                                        @error('tanggal')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('jumlah') is-invalid @enderror"
                                            ...
                                            value="{{ old('jumlah', $saranaTransportasi->jumlah) }}" min="0"
