...
@section('title', 'Edit Data Prasarana dan Irigasi')
...
<div class="card shadow-sm">
    <div class="card-header text-dark">
        <h5 class="card-title mb-0">
            ...
            Edit Data Prasarana dan Irigasi
        </h5>
    </div>

    <div class="card-body">
        <form action="{{ route('potensi.potensi-prasarana-dan-sarana.irigasi.update', $irigasi->id) }}" method="POST">
            @csrf
            @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('desa_id') is-invalid @enderror" id="desa_id" name="desa_id" required>
                            ...
                            @foreach ($desas as $desa)
                                <option value="{{ $desa->id }}" {{ old('desa_id', $irigasi->desa_id) == $desa->id ? 'selected' : '' }}>
                                    {{ $desa->nama_desa }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal"
                            name="tanggal" value="{{ old('tanggal', $irigasi->tanggal->format('Y-m-d')) }}" required>
                        @error('tanggal')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('saluran_primer') is-invalid @enderror"
                            id="saluran_primer" name="saluran_primer" value="{{ old('saluran_primer', $irigasi->saluran_primer) }}" min="0" step="0.01" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('saluran_primer_rusak') is-invalid @enderror"
                            id="saluran_primer_rusak" name="saluran_primer_rusak" value="{{ old('saluran_primer_rusak', $irigasi->saluran_primer_rusak) }}" min="0" step="0.01" required oninput="checkRusak('saluran_primer', 'saluran_primer_rusak')">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('saluran_sekunder') is-invalid @enderror"
                            id="saluran_sekunder" name="saluran_sekunder" value="{{ old('saluran_sekunder', $irigasi->saluran_sekunder) }}" min="0" step="0.01" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('saluran_sekunder_rusak') is-invalid @enderror"
                            id="saluran_sekunder_rusak" name="saluran_sekunder_rusak" value="{{ old('saluran_sekunder_rusak', $irigasi->saluran_sekunder_rusak) }}" min="0" step="0.01" required oninput="checkRusak('saluran_sekunder', 'saluran_sekunder_rusak')">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('saluran_tersier') is-invalid @enderror"
                            id="saluran_tersier" name="saluran_tersier" value="{{ old('saluran_tersier', $irigasi->saluran_tersier) }}" min="0" step="0.01" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('saluran_tersier_rusak') is-invalid @enderror"
                            id="saluran_tersier_rusak" name="saluran_tersier_rusak" value="{{ old('saluran_tersier_rusak', $irigasi->saluran_tersier_rusak) }}" min="0" step="0.01" required oninput="checkRusak('saluran_tersier', 'saluran_tersier_rusak')">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('pintu_sadap') is-invalid @enderror"
                            id="pintu_sadap" name="pintu_sadap" value="{{ old('pintu_sadap', $irigasi->pintu_sadap) }}" min="0" required>
                        @error('pintu_sadap')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('pintu_sadap_rusak') is-invalid @enderror"
                            id="pintu_sadap_rusak" name="pintu_sadap_rusak" value="{{ old('pintu_sadap_rusak', $irigasi->pintu_sadap_rusak) }}" min="0" required oninput="checkRusak('pintu_sadap', 'pintu_sadap_rusak')">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('pintu_pembagi_air') is-invalid @enderror"
                            id="pintu_pembagi_air" name="pintu_pembagi_air" value="{{ old('pintu_pembagi_air', $irigasi->pintu_pembagi_air) }}" min="0" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('pintu_pembagi_air_rusak') is-invalid @enderror"
                            id="pintu_pembagi_air_rusak" name="pintu_pembagi_air_rusak" value="{{ old('pintu_pembagi_air_rusak', $irigasi->pintu_pembagi_air_rusak) }}" min="0" required oninput="checkRusak('pintu_pembagi_air', 'pintu_pembagi_air_rusak')">
