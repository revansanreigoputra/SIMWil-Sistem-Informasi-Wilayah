...
@section('title', 'Edit Data Prasarana Air Bersih')
...
<div class="card shadow-sm">
    <div class="card-header text-dark">
        <h5 class="card-title mb-0">
            ...
            Edit Data Prasarana Air Bersih
        </h5>
    </div>

    <div class="card-body">
        <form action="{{ route('potensi.potensi-prasarana-dan-sarana.prasarana-air-bersih.update', $airBersih->id) }}" method="POST">
            @csrf
            @method('PUT')
                    ...
                    {{-- <div class="mb-3">
                        ...
                        <select class="form-select @error('desa_id') is-invalid @enderror" id="desa_id" name="desa_id" required>
                            ...
                            @foreach ($desas as $desa)
                                <option value="{{ $desa->id }}" {{ old('desa_id', $airBersih->desa_id) == $desa->id ? 'selected' : '' }}>{{ $desa->nama_desa }}</option>
                            @endforeach
                        </select>
                        @error('desa_id')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                               id="tanggal" name="tanggal" value="{{ old('tanggal', $airBersih->tanggal->format('Y-m-d')) }}" required>
                        @error('tanggal')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('sumur_pompa') is-invalid @enderror"
                               id="sumur_pompa" name="sumur_pompa" value="{{ old('sumur_pompa', $airBersih->sumur_pompa) }}"
                               min="0" required>
                        @error('sumur_pompa')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('sumur_gali') is-invalid @enderror"
                               id="sumur_gali" name="sumur_gali" value="{{ old('sumur_gali', $airBersih->sumur_gali) }}"
                               min="0" required>
                        @error('sumur_gali')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('mata_air') is-invalid @enderror"
                               id="mata_air" name="mata_air" value="{{ old('mata_air', $airBersih->mata_air) }}"
                               min="0" required>
                        @error('mata_air')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('embung') is-invalid @enderror"
                               id="embung" name="embung" value="{{ old('embung', $airBersih->embung) }}"
                               min="0" required>
                        @error('embung')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('hidran_umum') is-invalid @enderror"
                               id="hidran_umum" name="hidran_umum" value="{{ old('hidran_umum', $airBersih->hidran_umum) }}"
                               min="0" required>
                        @error('hidran_umum')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('tangki_air_bersih') is-invalid @enderror"
                               id="tangki_air_bersih" name="tangki_air_bersih" value="{{ old('tangki_air_bersih', $airBersih->tangki_air_bersih) }}"
                               min="0" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('penampung_air_hujan') is-invalid @enderror"
                               id="penampung_air_hujan" name="penampung_air_hujan" value="{{ old('penampung_air_hujan', $airBersih->penampung_air_hujan) }}"
                               min="0" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('bangunan_pengolahan_air') is-invalid @enderror"
                               id="bangunan_pengolahan_air" name="bangunan_pengolahan_air" value="{{ old('bangunan_pengolahan_air', $airBersih->bangunan_pengolahan_air) }}"
                               min="0" required>
