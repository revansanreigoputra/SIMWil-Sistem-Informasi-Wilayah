                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('sumur_pompa') is-invalid @enderror"
                                id="sumur_pompa" name="sumur_pompa" value="{{ old('sumur_pompa', 0) }}" min="0"
                                required>
                            @error('sumur_pompa')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('sumur_gali') is-invalid @enderror"
                                id="sumur_gali" name="sumur_gali" value="{{ old('sumur_gali', 0) }}" min="0"
                                required>
                            @error('sumur_gali')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('mata_air') is-invalid @enderror"
                                id="mata_air" name="mata_air" value="{{ old('mata_air', 0) }}" min="0" required>
                            @error('mata_air')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('embung') is-invalid @enderror" id="embung"
                                name="embung" value="{{ old('embung', 0) }}" min="0" required>
                            @error('embung')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('hidran_umum') is-invalid @enderror"
                                id="hidran_umum" name="hidran_umum" value="{{ old('hidran_umum', 0) }}" min="0"
                                required>
                            @error('hidran_umum')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tangki_air_bersih') is-invalid @enderror"
                                id="tangki_air_bersih" name="tangki_air_bersih"
                                value="{{ old('tangki_air_bersih', 0) }}" min="0" required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('penampung_air_hujan') is-invalid @enderror"
                                id="penampung_air_hujan" name="penampung_air_hujan"
                                value="{{ old('penampung_air_hujan', 0) }}" min="0" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number"
                                class="form-control @error('bangunan_pengolahan_air') is-invalid @enderror"
                                id="bangunan_pengolahan_air" name="bangunan_pengolahan_air"
                                value="{{ old('bangunan_pengolahan_air', 0) }}" min="0" required>
