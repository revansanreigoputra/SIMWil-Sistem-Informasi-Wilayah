                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex align-items-center">
                            ...
                            <h4 class="card-title mb-0">Tambah Data Dusun</h4>
                        </div>
                    </div>
                </div>

                <form action="{{ route('potensi.potensi-prasarana-dan-sarana.prasarana-dusun.store') }}" method="POST">
                    @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('alat_tulis_kantor') is-invalid @enderror"
                                            ...
                                            <option value="">-- Pilih Status --</option>
                                            <option value="ada" {{ old('alat_tulis_kantor') == 'ada' ? 'selected' : '' }}>Ada
                                            </option>
                                            <option value="tidak ada"
                                                {{ old('alat_tulis_kantor') == 'tidak ada' ? 'selected' : '' }}>Tidak Ada
                                            </option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('barang_inventaris') is-invalid @enderror"
                                            ...
                                            <option value="">-- Pilih Status --</option>
                                            <option value="ada" {{ old('barang_inventaris') == 'ada' ? 'selected' : '' }}>Ada
                                            </option>
                                            <option value="tidak ada"
                                                {{ old('barang_inventaris') == 'tidak ada' ? 'selected' : '' }}>Tidak Ada
                                            </option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('buku_administrasi') is-invalid @enderror"
                                            ...
                                            <option value="">-- Pilih Status --</option>
                                            <option value="ada" {{ old('buku_administrasi') == 'ada' ? 'selected' : '' }}>Ada
                                            </option>
                                            <option value="tidak ada"
                                                {{ old('buku_administrasi') == 'tidak ada' ? 'selected' : '' }}>Tidak Ada
                                            </option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            name="jenis_kegiatan" value="{{ old('jenis_kegiatan', 0) }}" min="0"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            name="jumlah_pengurus" value="{{ old('jumlah_pengurus', 0) }}" min="0"
                                            placeholder="Masukkan jumlah">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('lainnya') is-invalid @enderror"
                                            ...
                                            <option value="">-- Pilih Status --</option>
                                            <option value="ada" {{ old('lainnya') == 'ada' ? 'selected' : '' }}>Ada
                                            </option>
                                            <option value="tidak ada"
                                                {{ old('lainnya') == 'tidak ada' ? 'selected' : '' }}>Tidak Ada
                                            </option>
                                        </select>
                                        @error('lainnya')
                                            <div class="invalid-feedback">{{ $message }}</div>
