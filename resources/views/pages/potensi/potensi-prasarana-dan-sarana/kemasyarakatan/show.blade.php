                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <p class="form-control-plaintext fw-bold fs-6">{{ $kemasyarakatan->desa->nama_desa }}</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <p class="form-control-plaintext fw-bold fs-6">
                                        {{ $kemasyarakatan->tanggal->format('d-m-Y') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <p class="form-control-plaintext">
                                            {{ $kemasyarakatan->buku_administrasi_lembaga_lkd ?: '-' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <p class="form-control-plaintext">
                                            {{ $kemasyarakatan->jumlah_meja_kursi_lkd ?: '-' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label class="form-label fw-semibold">Buku Administrasi Lembaga</label>
                                        <p class="form-control-plaintext">
                                            {{ $kemasyarakatan->buku_administrasi_lembaga_lpm ?: '-' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label class="form-label fw-semibold">Jumlah Meja Kursi</label>
                                        <p class="form-control-plaintext">
                                            {{ $kemasyarakatan->jumlah_meja_kursi_lpm ?: '-' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <p class="form-control-plaintext">
                                            {{ $kemasyarakatan->buku_administrasi_lpm ?: '-' }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <p class="form-control-plaintext">{{ $kemasyarakatan->jumlah_kegiatan_lpm ?: '-' }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label class="form-label fw-semibold">Buku Administrasi</label>
                                        <p class="form-control-plaintext">
                                            {{ $kemasyarakatan->buku_administrasi_pkk ?: '-' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label class="form-label fw-semibold">Jumlah Kegiatan</label>
                                        <p class="form-control-plaintext">
                                            {{ $kemasyarakatan->jumlah_kegiatan_pkk ?: '-' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
