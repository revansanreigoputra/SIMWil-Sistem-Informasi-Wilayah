...
@section('title', 'Edit Data Kemasyarakatan')
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex align-items-center">
                            ...
                            <h4 class="card-title mb-0">Edit Data Kemasyarakatan</h4>
                        </div>
                    </div>
                </div>

                <form action="{{ route('potensi.potensi-prasarana-dan-sarana.kemasyarakatan.update', $kemasyarakatan->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                            ...
                                            value="{{ old('tanggal', $kemasyarakatan->tanggal->format('Y-m-d')) }}"
                                            required>
                                        @error('tanggal')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="gedung_lembaga_kemasyarakatan">
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('gedung_lembaga_kemasyarakatan', $kemasyarakatan->gedung_lembaga_kemasyarakatan) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('gedung_lembaga_kemasyarakatan', $kemasyarakatan->gedung_lembaga_kemasyarakatan) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('peralatan_kantor_lkd') is-invalid @enderror"
                                            ...
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('peralatan_kantor_lkd', $kemasyarakatan->peralatan_kantor_lkd) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('peralatan_kantor_lkd', $kemasyarakatan->peralatan_kantor_lkd) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('mesin_tik_lkd') is-invalid @enderror"
                                            ...
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('mesin_tik_lkd', $kemasyarakatan->mesin_tik_lkd) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('mesin_tik_lkd', $kemasyarakatan->mesin_tik_lkd) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('mesin_tik_lkd')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('kardek_lkd') is-invalid @enderror"
                                            ...
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('kardek_lkd', $kemasyarakatan->kardek_lkd) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('kardek_lkd', $kemasyarakatan->kardek_lkd) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('kardek_lkd')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('lainnya_lkd') is-invalid @enderror"
                                            ...
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('lainnya_lkd', $kemasyarakatan->lainnya_lkd) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('lainnya_lkd', $kemasyarakatan->lainnya_lkd) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('lainnya_lkd')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('buku_administrasi_lembaga_lkd', $kemasyarakatan->buku_administrasi_lembaga_lkd) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('jumlah_meja_kursi_lkd', $kemasyarakatan->jumlah_meja_kursi_lkd) }}"
                                            placeholder="Masukkan jumlah" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('memiliki_kantor_sendiri') is-invalid @enderror"
                                            id="memiliki_kantor_sendiri" name="memiliki_kantor_sendiri" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('memiliki_kantor_sendiri', $kemasyarakatan->memiliki_kantor_sendiri) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('memiliki_kantor_sendiri', $kemasyarakatan->memiliki_kantor_sendiri) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('peralatan_kantor_lpm') is-invalid @enderror"
                                            id="peralatan_kantor_lpm" name="peralatan_kantor_lpm" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('peralatan_kantor_lpm', $kemasyarakatan->peralatan_kantor_lpm) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('peralatan_kantor_lpm', $kemasyarakatan->peralatan_kantor_lpm) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('mesin_tik_lpm') is-invalid @enderror"
                                            id="mesin_tik_lpm" name="mesin_tik_lpm" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('mesin_tik_lpm', $kemasyarakatan->mesin_tik_lpm) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('mesin_tik_lpm', $kemasyarakatan->mesin_tik_lpm) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('mesin_tik_lpm')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('kardek_lpm') is-invalid @enderror"
                                            id="kardek_lpm" name="kardek_lpm" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('kardek_lpm', $kemasyarakatan->kardek_lpm) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('kardek_lpm', $kemasyarakatan->kardek_lpm) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('kardek_lpm')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('lainnya_lpm') is-invalid @enderror"
                                            id="lainnya_lpm" name="lainnya_lpm" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('lainnya_lpm', $kemasyarakatan->lainnya_lpm) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('lainnya_lpm', $kemasyarakatan->lainnya_lpm) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('lainnya_lpm')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('buku_administrasi_lembaga_lpm', $kemasyarakatan->buku_administrasi_lembaga_lpm) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('jumlah_meja_kursi_lpm', $kemasyarakatan->jumlah_meja_kursi_lpm) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('buku_administrasi_lpm', $kemasyarakatan->buku_administrasi_lpm) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('jumlah_kegiatan_lpm', $kemasyarakatan->jumlah_kegiatan_lpm) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('pkk') is-invalid @enderror" id="pkk"
                                            ...
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('pkk', $kemasyarakatan->pkk) == 'Ada' ? 'selected' : '' }}>Ada
                                            </option>
                                            <option value="Tidak Ada"
                                                {{ old('pkk', $kemasyarakatan->pkk) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('pkk')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('gedung_kantor_pkk') is-invalid @enderror"
                                            id="gedung_kantor_pkk" name="gedung_kantor_pkk" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('gedung_kantor_pkk', $kemasyarakatan->gedung_kantor_pkk) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('gedung_kantor_pkk', $kemasyarakatan->gedung_kantor_pkk) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('peralatan_kantor_pkk') is-invalid @enderror"
                                            id="peralatan_kantor_pkk" name="peralatan_kantor_pkk" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('peralatan_kantor_pkk', $kemasyarakatan->peralatan_kantor_pkk) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('peralatan_kantor_pkk', $kemasyarakatan->peralatan_kantor_pkk) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('kepengurusan_pkk') is-invalid @enderror"
                                            id="kepengurusan_pkk" name="kepengurusan_pkk" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('kepengurusan_pkk', $kemasyarakatan->kepengurusan_pkk) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('kepengurusan_pkk', $kemasyarakatan->kepengurusan_pkk) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('kegiatan_pkk') is-invalid @enderror"
                                            id="kegiatan_pkk" name="kegiatan_pkk" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('kegiatan_pkk', $kemasyarakatan->kegiatan_pkk) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('kegiatan_pkk', $kemasyarakatan->kegiatan_pkk) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('kegiatan_pkk')
                                            <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('buku_administrasi_pkk', $kemasyarakatan->buku_administrasi_pkk) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('jumlah_kegiatan_pkk', $kemasyarakatan->jumlah_kegiatan_pkk) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select
                                            class="form-select @error('kelengkapan_darmawisata_pkk') is-invalid @enderror"
                                            id="kelengkapan_darmawisata_pkk" name="kelengkapan_darmawisata_pkk" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('kelengkapan_darmawisata_pkk', $kemasyarakatan->kelengkapan_darmawisata_pkk) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('kelengkapan_darmawisata_pkk', $kemasyarakatan->kelengkapan_darmawisata_pkk) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('kelengkapan_pokja_pkk') is-invalid @enderror"
                                            id="kelengkapan_pokja_pkk" name="kelengkapan_pokja_pkk" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('kelengkapan_pokja_pkk', $kemasyarakatan->kelengkapan_pokja_pkk) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('kelengkapan_pokja_pkk', $kemasyarakatan->kelengkapan_pokja_pkk) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('karang_taruna') is-invalid @enderror"
                                            id="karang_taruna" name="karang_taruna" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="ada"
                                                {{ old('karang_taruna', $kemasyarakatan->karang_taruna) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="tidak ada"
                                                {{ old('karang_taruna', $kemasyarakatan->karang_taruna) == 'tidak ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('karang_taruna')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('kepengurusan_karang') is-invalid @enderror"
                                            id="kepengurusan_karang" name="kepengurusan_karang" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('kepengurusan_karang', $kemasyarakatan->kepengurusan_karang) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('kepengurusan_karang', $kemasyarakatan->kepengurusan_karang) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('buku_administrasi_karang', $kemasyarakatan->buku_administrasi_karang) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('jumlah_kegiatan_karang', $kemasyarakatan->jumlah_kegiatan_karang) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('lainnya_karang') is-invalid @enderror"
                                            id="lainnya_karang" name="lainnya_karang" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="ada"
                                                {{ old('lainnya_karang', $kemasyarakatan->lainnya_karang) == 'ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="tidak ada"
                                                {{ old('lainnya_karang', $kemasyarakatan->lainnya_karang) == 'tidak ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('lainnya_karang')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('rukun_tangga') is-invalid @enderror"
                                            id="rukun_tangga" name="rukun_tangga" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('rukun_tangga', $kemasyarakatan->rukun_tangga) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('rukun_tangga', $kemasyarakatan->rukun_tangga) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('rukun_tangga')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('kepengurusan_rt') is-invalid @enderror"
                                            id="kepengurusan_rt" name="kepengurusan_rt" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('kepengurusan_rt', $kemasyarakatan->kepengurusan_rt) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('kepengurusan_rt', $kemasyarakatan->kepengurusan_rt) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('buku_administrasi_rt', $kemasyarakatan->buku_administrasi_rt) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('jumlah_kegiatan_rt', $kemasyarakatan->jumlah_kegiatan_rt) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('rukun_warga') is-invalid @enderror"
                                            id="rukun_warga" name="rukun_warga" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('rukun_warga', $kemasyarakatan->rukun_warga) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('rukun_warga', $kemasyarakatan->rukun_warga) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('rukun_warga')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('kepengurusan_rw') is-invalid @enderror"
                                            id="kepengurusan_rw" name="kepengurusan_rw" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('kepengurusan_rw', $kemasyarakatan->kepengurusan_rw) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="tidak Ada"
                                                {{ old('kepengurusan_rw', $kemasyarakatan->kepengurusan_rw) == 'tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('buku_administrasi_rw', $kemasyarakatan->buku_administrasi_rw) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('jumlah_kegiatan_rw', $kemasyarakatan->jumlah_kegiatan_rw) }}"
                                            placeholder="Masukkan jumlah" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('lainnya_rw') is-invalid @enderror"
                                            id="lainnya_rw" name="lainnya_rw" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('lainnya_rw', $kemasyarakatan->lainnya_rw) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('lainnya_rw', $kemasyarakatan->lainnya_rw) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('lainnya_rw')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('lembaga_adat') is-invalid @enderror"
                                            id="lembaga_adat" name="lembaga_adat" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('lembaga_adat', $kemasyarakatan->lembaga_adat) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('lembaga_adat', $kemasyarakatan->lembaga_adat) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('lembaga_adat')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('gedung_kantor_adat') is-invalid @enderror"
                                            id="gedung_kantor_adat" name="gedung_kantor_adat" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('gedung_kantor_adat', $kemasyarakatan->gedung_kantor_adat) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('gedung_kantor_adat', $kemasyarakatan->gedung_kantor_adat) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('kepengurusan_adat') is-invalid @enderror"
                                            id="kepengurusan_adat" name="kepengurusan_adat" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('kepengurusan_adat', $kemasyarakatan->kepengurusan_adat) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('kepengurusan_adat', $kemasyarakatan->kepengurusan_adat) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('buku_administrasi_adat', $kemasyarakatan->buku_administrasi_adat) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('jumlah_kegiatan_adat', $kemasyarakatan->jumlah_kegiatan_adat) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('bumdes') is-invalid @enderror" id="bumdes"
                                            name="bumdes" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('bumdes', $kemasyarakatan->bumdes) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('bumdes', $kemasyarakatan->bumdes) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('bumdes')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('gedung_kantor_bumdes') is-invalid @enderror"
                                            id="gedung_kantor_bumdes" name="gedung_kantor_bumdes" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('gedung_kantor_bumdes', $kemasyarakatan->gedung_kantor_bumdes) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('gedung_kantor_bumdes', $kemasyarakatan->gedung_kantor_bumdes) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('kepengurusan_bumdes') is-invalid @enderror"
                                            id="kepengurusan_bumdes" name="kepengurusan_bumdes" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('kepengurusan_bumdes', $kemasyarakatan->kepengurusan_bumdes) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('kepengurusan_bumdes', $kemasyarakatan->kepengurusan_bumdes) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('buku_administrasi_bumdes', $kemasyarakatan->buku_administrasi_bumdes) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('jumlah_kegiatan_bumdes', $kemasyarakatan->jumlah_kegiatan_bumdes) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('forum_komunikasi_kader') is-invalid @enderror"
                                            id="forum_komunikasi_kader" name="forum_komunikasi_kader" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('forum_komunikasi_kader', $kemasyarakatan->forum_komunikasi_kader) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('forum_komunikasi_kader', $kemasyarakatan->forum_komunikasi_kader) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('gedung_kantor_forum') is-invalid @enderror"
                                            id="gedung_kantor_forum" name="gedung_kantor_forum" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('gedung_kantor_forum', $kemasyarakatan->gedung_kantor_forum) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('gedung_kantor_forum', $kemasyarakatan->gedung_kantor_forum) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('kepengurusan_forum') is-invalid @enderror"
                                            id="kepengurusan_forum" name="kepengurusan_forum" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('kepengurusan_forum', $kemasyarakatan->kepengurusan_forum) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('kepengurusan_forum', $kemasyarakatan->kepengurusan_forum) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('buku_administrasi_forum', $kemasyarakatan->buku_administrasi_forum) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('jumlah_kegiatan_forum', $kemasyarakatan->jumlah_kegiatan_forum) }}"
                                            placeholder="Masukkan jumlah" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('lainnya_forum') is-invalid @enderror"
                                            id="lainnya_forum" name="lainnya_forum" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('lainnya_forum', $kemasyarakatan->lainnya_forum) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('lainnya_forum', $kemasyarakatan->lainnya_forum) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                        @error('lainnya_forum')
                                            <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select
                                            class="form-select @error('gedung_kantor_sosial_lain') is-invalid @enderror"
                                            id="gedung_kantor_sosial_lain" name="gedung_kantor_sosial_lain" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('gedung_kantor_sosial_lain', $kemasyarakatan->gedung_kantor_sosial_lain) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('gedung_kantor_sosial_lain', $kemasyarakatan->gedung_kantor_sosial_lain) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select
                                            class="form-select @error('gedung_kantor_profesi_lain') is-invalid @enderror"
                                            id="gedung_kantor_profesi_lain" name="gedung_kantor_profesi_lain" required>
                                            <option value="">-- Pilih Status --</option>
                                            <option value="Ada"
                                                {{ old('gedung_kantor_profesi_lain', $kemasyarakatan->gedung_kantor_profesi_lain) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak Ada"
                                                {{ old('gedung_kantor_profesi_lain', $kemasyarakatan->gedung_kantor_profesi_lain) == 'Tidak Ada' ? 'selected' : '' }}>
                                                Tidak Ada</option>
                                        </select>
