            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('kategori_prasarana_transportasi_darat_id') is-invalid @enderror" 
                                id="kategori_prasarana_transportasi_darat_id" name="kategori_prasarana_transportasi_darat_id" required>
                            <option value="">-- Pilih Kategori --</option>
                            @foreach($kategoris as $kategori)
                                <option value="{{ $kategori->id }}" {{ old('kategori_prasarana_transportasi_darat_id', $transportasiDarat->kategori_prasarana_transportasi_darat_id) == $kategori->id ? 'selected' : '' }}>
                                    {{ $kategori->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('kondisi_baik') is-invalid @enderror" 
                                   id="kondisi_baik" name="kondisi_baik" 
                                   value="{{ old('kondisi_baik', $transportasiDarat->kondisi_baik) }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('kondisi_rusak') is-invalid @enderror" 
                                   id="kondisi_rusak" name="kondisi_rusak" 
                                   value="{{ old('kondisi_rusak', $transportasiDarat->kondisi_rusak) }}" 
                                   min="0" step="0.01" required placeholder="0">
                            <span class="input-group-text">m</span>
                        </div>
                        @error('kondisi_rusak')
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        <label for="jumlah" class="form-label fw-semibold">
                            ...
                            Total Jumlah <small class="text-muted">(Meter/Unit)</small> <span class="text-danger">*</span>
                        </label>
                        <div class="input-group">
                            <input type="number" class="form-control @error('jumlah') is-invalid @enderror"
                                   id="jumlah" name="jumlah"
                                   value="{{ old('jumlah', $transportasiDarat->jumlah) }}"
                                   min="0" step="0.01" required placeholder="0" readonly>
...
@push('addon-script')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const selectedJenisId = "{{ old('jenis_prasarana_transportasi_darat_id', $transportasiDarat->jenis_prasarana_transportasi_darat_id) }}";
            ...
            kategoriSelect.addEventListener('change', populateJenisDropdown);
