...
@section('title', 'Detail Data Sarana Kesehatan')
    ...
    <div class="container-fluid px-4">
        ...
        <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
            ...
            <div class="card-body p-4">
                <!-- Data Sarana Kesehatan Section -->
                <div class="mb-4">
                    <div class="d-flex align-items-center mb-3">
                        <div class="bg-primary bg-opacity-10 rounded-2 p-2 me-2">
                            <i class="fas fa-hospital text-primary"></i>
                        </div>
                        <h6 class="mb-0 fw-bold text-dark">Data Sarana Kesehatan</h6>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <h6 class="mb-0 fw-bold text-dark">
                                                {{ number_format($saranakesehatan->jumlah) }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center p-3 bg-light rounded-3">
                                ...
                                <div>
                                    ...
                                    <span
                                        class="fw-semibold text-dark">{{ $saranakesehatan->created_at?->format('d M Y, H:i') ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center p-3 bg-light rounded-3">
                                ...
                                <div>
                                    ...
                                    <span
                                        class="fw-semibold text-dark">{{ $saranakesehatan->updated_at?->format('d M Y, H:i') ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-footer bg-white border-top py-3">
                <div class="d-flex justify-content-between align-items-center">
                    <a href="{{ route('potensi.potensi-prasarana-dan-sarana.skesehatan.index') }}"
                        class="btn btn-light border px-4">
                        <i class="fas fa-arrow-left me-2"></i>
                        Kembali
                    </a>
                    @can('skesehatan.update')
                        <a href="{{ route('potensi.potensi-prasarana-dan-sarana.skesehatan.edit', $saranakesehatan->id) }}"
