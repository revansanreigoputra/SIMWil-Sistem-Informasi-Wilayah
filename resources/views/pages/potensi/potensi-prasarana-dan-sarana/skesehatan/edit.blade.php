...
@section('title', 'Edit Data Sarana Kesehatan')
    ...
    <div class="card shadow-sm">
        <div class="card-header text-dark">
            <h5 class="card-title mb-0">
                ...
                Edit Data Sarana Kesehatan
            </h5>
        </div>

        <div class="card-body">
            <form
                action="{{ route('potensi.potensi-prasarana-dan-sarana.skesehatan.update', ['saranakesehatan' => $saranakesehatan->id]) }}"
                method="POST">
                @csrf
                @method('PUT')
