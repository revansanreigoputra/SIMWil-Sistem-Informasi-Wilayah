...
@section('title', 'Tambah Data Sarana Kesehatan')
    ...
    <div class="card shadow-sm">
        <div class="card-header text-dark">
            <h5 class="card-title mb-0">
                ...
                Tambah Data Sarana Kesehatan
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('potensi.potensi-prasarana-dan-sarana.skesehatan.store') }}" method="POST">
                @csrf
                ...
                <h6 class="fw-bold text-primary mb-3">Data Sarana Kesehatan</h6>
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="jskesehatan_id" class="form-label fw-semibold">
                            ...
                            <select class="form-select @error('jenis_sarana_kesehatan_id') is-invalid @enderror"
                                ...
                                @foreach ($jenisSaranaKesehatans as $jenis)
                                    <option value="{{ $jenis->id }}"
                                        {{ old('jenis_sarana_kesehatan_id') == $jenis->id ? 'selected' : '' }}>
                                        {{ $jenis->nama }}
                                    </option>
                                @endforeach
                            </select>
