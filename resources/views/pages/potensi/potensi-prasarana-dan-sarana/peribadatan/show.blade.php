...
@section('title', 'Detail Data Prasarana Peribadatan')
    ...
    <div class="container-fluid px-4">
        ...
        <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <h3 class="mb-0 fw-bold text-dark">
                            {{ $prasaranaPeribadatan->desa->nama_desa }} - {{ $prasaranaPeribadatan->tanggal?->format('d F Y') ?? '-' }}
                        </h3>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body p-4">
                <!-- Data Prasarana Peribadatan Section -->
                <div class="mb-4">
                    <div class="d-flex align-items-center mb-3">
                        <div class="bg-primary bg-opacity-10 rounded-2 p-2 me-2">
                            <i class="fas fa-place-of-worship text-primary"></i>
                        </div>
                        <h6 class="mb-0 fw-bold text-dark">Data Prasarana Peribadatan</h6>
                    </div>
                                    ...
                                    <div class="d-flex align-items-start">
                                        <div class="flex-shrink-0">
                                            <div class="icon-wrapper bg-info bg-opacity-10 rounded-2 p-2">
                                                <i class="fas fa-place-of-worship text-info"></i>
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <label class="text-muted small mb-1 d-block">Tempat Ibadah</label>
                                            <h6 class="mb-0 fw-bold text-dark">
                                                {{ $prasaranaPeribadatan->tempatIbadah?->nama_tempat ?? '-' }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <h6 class="mb-0 fw-bold text-dark">
                                                {{ number_format($prasaranaPeribadatan->jumlah) }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center p-3 bg-light rounded-3">
                                ...
                                <div>
                                    ...
                                    <span
                                        class="fw-semibold text-dark">{{ $prasaranaPeribadatan->created_at?->format('d M Y, H:i') ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center p-3 bg-light rounded-3">
                                ...
                                <div>
                                    ...
                                    <span
                                        class="fw-semibold text-dark">{{ $prasaranaPeribadatan->updated_at?->format('d M Y, H:i') ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-footer bg-white border-top py-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    @can('peribadatan.update')
                        <a href="{{ route('potensi.potensi-prasarana-dan-sarana.peribadatan.edit', $prasaranaPeribadatan->id) }}"
