...
@section('title', 'Tambah Data Energi Penerangan')
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex align-items-center">
                            ...
                            <h4 class="card-title mb-0">Tambah Data Energi Penerangan</h4>
                        </div>
                    </div>
                </div>

                <form action="{{ route('potensi.potensi-prasarana-dan-sarana.energiPenerangan.store') }}" method="POST">
                    @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('listrik_pln') is-invalid @enderror"
                                               id="listrik_pln" name="listrik_pln" value="{{ old('listrik_pln', 0) }}"
                                               min="0" required>
                                        @error('listrik_pln')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('diesel_umum') is-invalid @enderror"
                                               id="diesel_umum" name="diesel_umum" value="{{ old('diesel_umum', 0) }}"
                                               min="0" required>
                                        @error('diesel_umum')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('genset_pribadi') is-invalid @enderror"
                                               id="genset_pribadi" name="genset_pribadi" value="{{ old('genset_pribadi', 0) }}"
                                               min="0" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('tanpa_penerangan') is-invalid @enderror"
                                               id="tanpa_penerangan" name="tanpa_penerangan" value="{{ old('tanpa_penerangan', 0) }}"
                                               min="0" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('lampu_minyak') is-invalid @enderror"
                                               id="lampu_minyak" name="lampu_minyak" value="{{ old('lampu_minyak', 0) }}"
                                               min="0" required>
                                        @error('lampu_minyak')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('kayu_bakar') is-invalid @enderror"
                                               id="kayu_bakar" name="kayu_bakar" value="{{ old('kayu_bakar', 0) }}"
                                               min="0" required>
                                        @error('kayu_bakar')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('batu_bara') is-invalid @enderror"
                                               id="batu_bara" name="batu_bara" value="{{ old('batu_bara', 0) }}"
                                               min="0" required>
                                        @error('batu_bara')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
