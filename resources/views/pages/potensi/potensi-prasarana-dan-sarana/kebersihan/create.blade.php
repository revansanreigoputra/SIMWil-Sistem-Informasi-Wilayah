...
@section('title', 'Tambah Data Prasarana Kebersihan')
    ...
    <div class="card shadow-sm">
        <div class="card-header text-dark">
            <h5 class="card-title mb-0">
                ...
                Tambah Data Prasarana Kebersihan
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('potensi.potensi-prasarana-dan-sarana.kebersihan.store') }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('tps_lokasi') is-invalid @enderror"
                                id="tps_lokasi" name="tps_lokasi" value="{{ old('tps_lokasi') }}">
                            @error('tps_lokasi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('tpa_lokasi') is-invalid @enderror"
                                id="tpa_lokasi" name="tpa_lokasi" value="{{ old('tpa_lokasi') }}">
                            @error('tpa_lokasi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('alat_penghancur') is-invalid @enderror"
                                id="alat_penghancur" name="alat_penghancur" value="{{ old('alat_penghancur') }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('gerobak_sampah') is-invalid @enderror"
                                id="gerobak_sampah" name="gerobak_sampah" value="{{ old('gerobak_sampah', 0) }}" min="0">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tong_sampah') is-invalid @enderror"
                                id="tong_sampah" name="tong_sampah" value="{{ old('tong_sampah', 0) }}" min="0">
                            @error('tong_sampah')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('truk_pengangkut') is-invalid @enderror"
                                id="truk_pengangkut" name="truk_pengangkut" value="{{ old('truk_pengangkut', 0) }}" min="0">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('satgas_kebersihan') is-invalid @enderror"
                                id="satgas_kebersihan" name="satgas_kebersihan" value="{{ old('satgas_kebersihan', 0) }}" min="0">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('anggota_satgas') is-invalid @enderror"
                                id="anggota_satgas" name="anggota_satgas" value="{{ old('anggota_satgas', 0) }}" min="0">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('pemulung') is-invalid @enderror"
                                id="pemulung" name="pemulung" value="{{ old('pemulung', 0) }}" min="0">
                            @error('pemulung')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('tempat_pengelolaan_sampah') is-invalid @enderror"
                                id="tempat_pengelolaan_sampah" name="tempat_pengelolaan_sampah" value="{{ old('tempat_pengelolaan_sampah') }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('pengelolaan_sampah_rt') is-invalid @enderror"
                                ...
                                <option value="pemerintah" {{ old('pengelolaan_sampah_rt') == 'pemerintah' ? 'selected' : '' }}>Pemerintah</option>
                                <option value="perorangan" {{ old('pengelolaan_sampah_rt') == 'perorangan' ? 'selected' : '' }}>Perorangan</option>
                                <option value="swadaya" {{ old('pengelolaan_sampah_rt') == 'swadaya' ? 'selected' : '' }}>Swadaya</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('pengelolaan_sampah_lainnya') is-invalid @enderror"
                                id="pengelolaan_sampah_lainnya" name="pengelolaan_sampah_lainnya" value="{{ old('pengelolaan_sampah_lainnya') }}">
