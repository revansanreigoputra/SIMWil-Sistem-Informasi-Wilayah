...
@section('title', 'Tambah Data Prasarana Olahraga')
    ...
    <div class="card shadow-sm">
        <div class="card-header text-dark">
            <h5 class="card-title mb-0">
                ...
                Tambah Data Prasarana Olahraga
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('potensi.potensi-prasarana-dan-sarana.olahraga.store') }}" method="POST">
                @csrf
