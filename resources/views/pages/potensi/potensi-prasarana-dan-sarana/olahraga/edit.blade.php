...
@section('title', 'Edit Data Prasarana Olahraga')
    ...
    <div class="card shadow-sm">
        <div class="card-header text-dark">
            <h5 class="card-title mb-0">
                ...
                Edit Data Prasarana Olahraga
            </h5>
        </div>

        <div class="card-body">
            <form
                action="{{ route('potensi.potensi-prasarana-dan-sarana.olahraga.update', ['prasarana_olahraga' => $prasaranaOlahraga->id]) }}"
                method="POST">
                @csrf
                @method('PUT')
                            ...
                            <select class="form-select @error('desa_id') is-invalid @enderror" id="desa_id"
                                ...
                                @foreach ($desas as $desa)
                                    <option value="{{ $desa->id }}"
                                        {{ old('desa_id', $prasaranaOlahraga->desa_id) == $desa->id ? 'selected' : '' }}>
                                        {{ $desa->nama_desa }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <h6 class="fw-bold text-primary mb-3">Data Prasarana Olahraga</h6>
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="jpolahraga_id" class="form-label fw-semibold">
