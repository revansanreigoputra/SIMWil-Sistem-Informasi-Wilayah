                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex align-items-center">
                            ...
                            <h4 class="card-title mb-0">Tambah Data BPD</h4>
                        </div>
                    </div>
                </div>

                <form action="{{ route('potensi.potensi-prasarana-dan-sarana.prasarana-bpd.store') }}" method="POST">
                    @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('balai_bpd') is-invalid @enderror" id="balai_bpd"
                                            ...
                                            <option value="tidak ada"
                                                {{ old('balai_bpd') == 'tidak ada' ? 'selected' : '' }}>Tidak Ada</option>
                                        </select>
                                        @error('balai_bpd')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('listrik') is-invalid @enderror" id="listrik"
                                            ...
                                            <option value="tidak ada"
                                                {{ old('listrik') == 'tidak ada' ? 'selected' : '' }}>Tidak Ada</option>
                                        </select>
                                        @error('listrik')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('telepon') is-invalid @enderror" id="telepon"
                                            ...
                                            <option value="tidak ada"
                                                {{ old('telepon') == 'tidak ada' ? 'selected' : '' }}>Tidak Ada</option>
                                        </select>
                                        @error('telepon')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <select class="form-select @error('inventaris_lainnya') is-invalid @enderror"
                                    ...
                                    <option value="">-- Pilih Status --</option>
                                    <option value="ada" {{ old('inventaris_lainnya') == 'ada' ? 'selected' : '' }}>Ada
                                    </option>
                                    <option value="tidak ada"
                                        {{ old('inventaris_lainnya') == 'tidak ada' ? 'selected' : '' }}>Tidak Ada</option>
                                </select>
