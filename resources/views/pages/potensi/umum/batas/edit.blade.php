...
@section('title', 'Edit Batas Wilayah')

@section('content')
    <div class="card shadow-sm">
        <div class="card-header text-dark">
            <h5 class="card-title mb-0">
                Edit Data Batas Wilayah
            </h5>
        </div>

        <div class="card-body">
            <form action="{{ route('batas-wilayah.update', $batas_wilayah->id) }}" method="POST">
                @csrf
                @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tahun_pembentukan') is-invalid @enderror"
                                        id="tahun_pembentukan" name="tahun_pembentukan"
                                        value="{{ old('tahun_pembentukan', $batas_wilayah->tahun_pembentukan) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('luas_desa') is-invalid @enderror"
                                        id="luas_desa" name="luas_desa" value="{{ old('luas_desa', $batas_wilayah->luas_desa) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kepala_desa') is-invalid @enderror"
                                        id="kepala_desa" name="kepala_desa" value="{{ old('kepala_desa', $batas_wilayah->kepala_desa) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_pengisi') is-invalid @enderror"
                                        id="nama_pengisi" name="nama_pengisi" value="{{ old('nama_pengisi', $batas_wilayah->nama_pengisi) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror"
                                        id="pekerjaan" name="pekerjaan" value="{{ old('pekerjaan', $batas_wilayah->pekerjaan) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('jabatan') is-invalid @enderror" id="jabatan"
                                        name="jabatan" value="{{ old('jabatan', $batas_wilayah->jabatan) }}" placeholder="Masukkan jabatan">
                                    @error('jabatan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal"
                                        name="tanggal"
                                        value="{{ old('tanggal', $batas_wilayah->tanggal ? $batas_wilayah->tanggal->format('Y-m-d') : '') }}">
                                    @error('tanggal')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('desa_utara') is-invalid @enderror"
                                        id="desa_utara" name="desa_utara" value="{{ old('desa_utara', $batas_wilayah->desa_utara) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('desa_selatan') is-invalid @enderror"
                                        id="desa_selatan" name="desa_selatan"
                                        value="{{ old('desa_selatan', $batas_wilayah->desa_selatan) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('desa_timur') is-invalid @enderror"
                                        id="desa_timur" name="desa_timur" value="{{ old('desa_timur', $batas_wilayah->desa_timur) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('desa_barat') is-invalid @enderror"
                                        id="desa_barat" name="desa_barat" value="{{ old('desa_barat', $batas_wilayah->desa_barat) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kec_utara') is-invalid @enderror"
                                        id="kec_utara" name="kec_utara" value="{{ old('kec_utara', $batas_wilayah->kec_utara) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kec_selatan') is-invalid @enderror"
                                        id="kec_selatan" name="kec_selatan" value="{{ old('kec_selatan', $batas_wilayah->kec_selatan) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kec_timur') is-invalid @enderror"
                                        id="kec_timur" name="kec_timur" value="{{ old('kec_timur', $batas_wilayah->kec_timur) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kec_barat') is-invalid @enderror"
                                        id="kec_barat" name="kec_barat" value="{{ old('kec_barat', $batas_wilayah->kec_barat) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('penetapan_batas') is-invalid @enderror"
                                        ...
                                        <option value="ada"
                                            {{ old('penetapan_batas', $batas_wilayah->penetapan_batas) == 'ada' ? 'selected' : '' }}>Ada
                                        </option>
                                        <option value="tidak ada"
                                            {{ old('penetapan_batas', $batas_wilayah->penetapan_batas) == 'tidak ada' ? 'selected' : '' }}>
                                            Tidak Ada</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('peta_wilayah') is-invalid @enderror" id="peta_wilayah"
                                        ...
                                        <option value="">-- Pilih --</option>
                                        <option value="ada"
                                            {{ old('peta_wilayah', $batas_wilayah->peta_wilayah) == 'ada' ? 'selected' : '' }}>Ada</option>
                                        <option value="tidak ada"
                                            {{ old('peta_wilayah', $batas_wilayah->peta_wilayah) == 'tidak ada' ? 'selected' : '' }}>Tidak
                                            Ada</option>
                                    </select>
                                    @error('peta_wilayah')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('dasar_hukum_perdes') is-invalid @enderror"
                                        ...
                                        value="{{ old('dasar_hukum_perdes', $batas_wilayah->dasar_hukum_perdes) }}"
                                        placeholder="Masukkan dasar hukum perdes">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('dasar_hukum_perda') is-invalid @enderror"
                                        id="dasar_hukum_perda" name="dasar_hukum_perda"
                                        value="{{ old('dasar_hukum_perda', $batas_wilayah->dasar_hukum_perda) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('referensi_1') is-invalid @enderror"
                                        id="referensi_1" name="referensi_1" value="{{ old('referensi_1', $batas_wilayah->referensi_1) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('referensi_2') is-invalid @enderror"
                                        id="referensi_2" name="referensi_2" value="{{ old('referensi_2', $batas_wilayah->referensi_2) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('referensi_3') is-invalid @enderror"
                                        id="referensi_3" name="referensi_3" value="{{ old('referensi_3', $batas_wilayah->referensi_3) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('referensi_4') is-invalid @enderror"
                                        id="referensi_4" name="referensi_4" value="{{ old('referensi_4', $batas_wilayah->referensi_4) }}"
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group gap-2">
                                ...
                                <button type="submit" class="btn btn-warning text-white rounded">
                                    Update Data
                                </button>
                            </div>
                        </div>
