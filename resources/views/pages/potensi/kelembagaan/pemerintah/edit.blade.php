...
<div class="card">
     <div class="card-header">
            <h5 class="card-title">Form Edit Data Lembaga Pemerintahan</h5>
        </div>
    <div class="card-body">
        ...
        <form id="form-pemerintahan">
            ...
            {{-- Data Umum --}}
            <div class="card mb-3 p-3 bg-light rounded-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value="Pemerintahan Desa">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value="Peraturan Desa No.1/2020">
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-3 p-3 bg-light rounded-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" value="Desa X">
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-3 p-3 bg-light rounded-4">
                <h6 class="fw-bold">Dasar Hukum Tambahan</h6>
                <div class="mb-2">
                    <label class="form-label">Dasar Hukum Pembentukan</label>
                    <textarea class="form-control" rows="2">Peraturan Desa No. 1/2020</textarea>
                </div>
                <div>
                    <label class="form-label">Dasar Hukum BPD</label>
                    <textarea class="form-control" rows="2">Peraturan BPD No. 2/2020</textarea>
                </div>
            </div>

            {{-- Data Aparat --}}
            <div class="card mb-3 p-3 bg-light rounded-4">
                <h6 class="fw-bold">Data Aparat</h6>
                <div class="row g-3">
                    <div class="col-md-6">
            ...
            {{-- Data Personil --}}
            <div class="card mb-3 p-3 bg-light rounded-4">
                <h6 class="fw-bold">Data Personil</h6>
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value="Siti">
                    </div>
                </div>
            </div>
