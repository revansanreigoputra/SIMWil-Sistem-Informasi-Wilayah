...
@section('action')
    <a href="{{ route('potensi.kelembagaan.kemasyarakatan.create') }}" class="btn btn-primary mb-3">
        Tambah Data
    </a>
@endsection
                        ...
                        <tr>
                            ...
                            <td>
                                 <div class="d-flex gap-1 justify-content-center">
                                    <a href="{{ route('potensi.kelembagaan.kemasyarakatan.show') }}" class="btn btn-sm btn-info">
                                        <i class="bi bi-eye"></i> Detail
                                    </a>
                                    <a href="{{ route('potensi.kelembagaan.kemasyarakatan.edit') }}" class="btn btn-sm btn-warning">
                                        <i class="bi bi-pencil-square"></i> Edit
                                    </a>
                                    <a href="{{ route('potensi.kelembagaan.kemasyarakatan.print', 1) }}" target="_blank" class="btn btn-sm btn-secondary">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Data dengan tanggal <strong>2025-10-02</strong> akan dihapus permanen.</p>
                                            </div>
                                ...
                                <div class="modal fade" id="deleteModal2" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Data dengan tanggal <strong>2025-09-15</strong> akan dihapus permanen.</p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                                <button type="button" class="btn btn-danger">Hapus</button>
