...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0 fw-bold">Form Tambah Data Usaha Jasa Pengangkutan</h5>
    </div>
    <div class="card-body">
        <form id="form-usaha-jasa">
            ...
            <div class="card mb-3 p-3 bg-light">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan alamat kantor">
                    </div>
                    <div class="col-md-12">
