...
@section('title', 'Tambah Kartu Keluarga Baru')

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="card-title">Form Tambah Kartu Keluarga (KK) Baru</h5>
    </div>
    <div class="card-body">
        {{-- Form Simpan KK --}}
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="no_kk" id="no_kk"
                           ...
                           value="{{ old('no_kk') }}" placeholder="Masukkan 16 digit Nomor KK" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="kepala_keluarga" id="kepala_keluarga"
                           ...
                           value="{{ old('kepala_keluarga') }}" placeholder="Sesuai yang tertera di KK" required>
                ...
                <div class="col-12">
                    ...
                    <textarea name="alamat" id="alamat"
                              ...
                              rows="2" placeholder="Alamat lengkap sesuai KK" required>{{ old('alamat') }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="dusun" id="dusun"
                           class="form-control" value="{{ old('dusun') }}" placeholder="Nama dusun/kampung">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="bulan" id="bulan" class="form-control"
                           value="{{ old('bulan', date('F')) }}" required>
                </div>
                ...
                {{-- Sumber Data (full width) --}}
                <div class="col-12">
                    <label for="sumber_data" class="form-label">Sumber Data</label>
                    <textarea name="sumber_data" id="sumber_data" class="form-control" rows="2">{{ old('sumber_data') }}</textarea>
                </div>
            </div>
