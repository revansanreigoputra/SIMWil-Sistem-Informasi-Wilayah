                ...
                <div class="card bg-light p-3 mb-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="no_kk" id="no_kk" class="form-control @error('no_kk') is-invalid @enderror" value="{{ old('no_kk') }}" required>
                            @error('no_kk')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="kepala_keluarga" id="kepala_keluarga" class="form-control @error('kepala_keluarga') is-invalid @enderror" value="{{ old('kepala_keluarga') }}" required>
                ...
                <div class="card bg-light p-3 mb-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" name="nik" id="nik" class="form-control @error('nik') is-invalid @enderror" value="{{ old('nik') }}" placeholder="16 Digit NIK" required>
                            @error('nik')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="no_akta_kelahiran" id="no_akta_kelahiran" class="form-control" value="{{ old('no_akta_kelahiran') }}">
                        </div>
                         <div class="col-md-4">
                            <label class="form-label" for="tanggal_pencatatan">Tanggal Pencatatan</label>
                            <input type="date" name="tanggal_pencatatan" id="tanggal_pencatatan" value="{{ old('tanggal_pencatatan', date('Y-m-d')) }}" class="form-control">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="hubungan_keluarga_id" id="hubungan_keluarga_id" class="form-select @error('hubungan_keluarga_id') is-invalid @enderror" required>
                                ...
                                {{-- Ensure $hubunganKeluarga is passed from controller --}}
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="etnis" id="etnis" class="form-control" value="{{ old('etnis') }}">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_orang_tua" id="nama_orang_tua" class="form-control" value="{{ old('nama_orang_tua') }}" required>
                        </div>
                        ...
                        <div class="col-md-6" id="nama-lembaga-container"   > 
                            ...
                            <input type="text" name="nama_lembaga" id="nama_lembaga" class="form-control" value="{{ old('nama_lembaga') }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <select name="nama_pengisi_id" id="nama_pengisi_id" class="form-control @error('nama_pengisi_id') is-invalid @enderror" required>
                                ...
                                <option value="{{ $perangkat->id }}" {{ old('nama_pengisi_id') == $perangkat->id ? 'selected' : '' }}>
                                    {{ $perangkat->nama }}
                                </option>
                                @endforeach
                            </select>
